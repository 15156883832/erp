 ...
 */
@Entity
@Table(name = "crm_goods_platform_order")
//@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class GoodsPlatformOrder implements Serializable{
	...
	public String getUserSiteMsg() {
		return userSiteMsg;
	}
	public void setUserSiteMsg(String userSiteMsg) {
		this.userSiteMsg = userSiteMsg;
	}
	...
	public Integer getFreeVipTime() {
		return freeVipTime;
	}

	public void setFreeVipTime(Integer freeVipTime) {
		this.freeVipTime = freeVipTime;
	}
