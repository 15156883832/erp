...
//            String formPath = request.getParameter("formPath");
            ...
            String siteId= CrmUtils.getCurrentSiteId(user);
            Map<String,Object> map = new TrimMap(getParams(request));
            SiteTableHeaderForm stf = JqGridTableUtils.getCustomizedTableHead(siteId, "/a/order2017/export/header");
    ...
    public String saveform(HttpServletRequest request, Model model) {
        ...
        String siteId = CrmUtils.getCurrentSiteId(UserUtils.getUser());
        Record order = order2017Dao.findOrderById(orId, siteId);
        ...
        model.addAttribute("category", category);
        model.addAttribute("brand", brand);
        model.addAttribute("order", order.getColumns());
        ...
        return "modules/" + "order/orderFormFromDetail2017";
    }
