...
public class HistoryBkOrder extends JBean {

	public HistoryBkOrder(Record record) {
		super(record);
	}
	...
	public void setRepairImgs(String repairImgs) {
		set("repair_imgs", repairImgs);
	}

	public String getRepairImgs() {
		return get("repair_imgs");
	}
	...
	public void setRecordAccountBy(String recordAccountBy) {
		set("record_account_by", recordAccountBy);
	}

	public String getRecordAccountBy() {
		return get("record_account_by");
	}
	...
	public void setCallbackCost(java.math.BigDecimal callbackCost) {
		set("callback_cost", callbackCost);
	}

	public java.math.BigDecimal getCallbackCost() {
		return get("callback_cost");
	}

	public void setRepairRecordAccount(String repairRecordAccount) {
		set("repair_record_account", repairRecordAccount);
	}

	public String getRepairRecordAccount() {
		return get("repair_record_account");
	}

	public void setRepairRecordAccountTime(java.util.Date repairRecordAccountTime) {
		set("repair_record_account_time", repairRecordAccountTime);
	}

	public java.util.Date getRepairRecordAccountTime() {
		return get("repair_record_account_time");
	}
	...
	public void setDisableType(String disableType) {
		set("disable_type", disableType);
	}

	public String getDisableType() {
		return get("disable_type");
	}

	public void setDisableResource(String disableResource) {
		set("disable_resource", disableResource);
	}

	public String getDisableResource() {
		return get("disable_resource");
	}
	...
	public String allContacts() {
		...
		if (!StringUtil.isBlank(getCustomerMobile())) {
