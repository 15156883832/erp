 ...
 */
package com.jojowonet.generate;

import ivan.common.utils.DateUtils;
import ivan.common.utils.FileUtils;
import ivan.common.utils.FreeMarkers;
...
public class CopyOfGenerate {
	...
	private static Logger logger = LoggerFactory.getLogger(CopyOfGenerate.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.jojowonet.modules";
		
		String moduleName = "order";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "OrderFeedback";			// 类名，例：user
		String classAuthor = "Ivan";		// 类作者，例：Ivan
		String functionName = "反馈";			// 功能名，例：用户
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/jojowonet/generate/template", "/", separator);
