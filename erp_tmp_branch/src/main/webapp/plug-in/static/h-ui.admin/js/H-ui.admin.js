...
$(function() {
    oUl=$("#min_title_list"),hide_nav=$("#Hui-tabNav");
});
...
function Hui_admin_tab(obj) {
    var bStop = false,
        ...
        alterHref = $(obj).attr('data-alter-href') || '',
    ...
    if (!bStop) {
        creatIframe(href, title, alterHref);
        // min_titleList();
    } else {
        show_navLi.removeClass("active").eq(bStopIndex).addClass("active");
        if (alterHref) {
            iframe_box.find(".show_iframe").hide().eq(bStopIndex).show().find("iframe").attr("src", alterHref);
        } else {
...
/*创建iframe*/
function creatIframe(href,titleName, alterHref){
...
/*			$('#Hui-tabNav').hide();
			...
			$('#menu_home').parent('dt').removeClass('current');
			
			/*$('#Hui-tabNav').show();
			$('#iframe_box').show();
			$('#welcomeIframe').hide();*/
			$('.Hui-aside .menu_dropdown li').removeClass('current');
