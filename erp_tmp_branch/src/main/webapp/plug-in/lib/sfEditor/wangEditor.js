...
var config = {
    ...
    // 默认菜单配置
    //menus: ['head', 'bold', 'italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo', 'preview'],
	menus: ['head','bold', 'link','italic','underline', 'strikeThrough', 'justify', 'foreColor', 'backColor', 'image', 'preview'],
    ...
    priviewHtmlSavePath: '',//保存预览html代码的路径
...
Preview.prototype = {
    ...
    onClick: function onClick() {
    	var config_ = this.editor.config; 
    	ETAjax.post(config_.priviewHtmlSavePath, "htmlContent="+this.editor.txt.html(), function(content){
    		console.log(content);
    		window.open(config_.previewUrl, "_blank");
    	});
    }
};
