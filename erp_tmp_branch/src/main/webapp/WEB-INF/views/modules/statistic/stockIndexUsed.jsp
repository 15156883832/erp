...
<div class="sfpagebg bk-gray" style="overflow: hidden;"><div class="sfpage">
	...
	<div id="tab-system" class="HuiTab">
		...
		<div class="mt-10 cl" id="allHeader">
			...
			<div class="f-l pl-20 pt-15 pb-15 bk-gray bgstyle" style="width: 28%;border-right: 0;cursor:pointer;" onclick="stockComStatistics(2,this)">
				<div class="stockbox stockbox5">
					<p class="money"><strong id="empPrice">￥0</strong></p>
					<p class="money-lb">工程师库存总资产</p>
				</div>
			</div>
			<div class="f-l pl-20 pt-15 pb-15 bk-gray stockboxCur bgstyle" style="width: 44%;cursor:pointer;" onclick="stockComStatistics(3,this)">
	...
	<%--<div class="mt-10 bk-gray pd-15">
		...
		<form action=""  id="cx">
			...
			<div class="cl mt-15">
				<input type="hidden" name="whoStatistics" id="whoStatistics" value="3">
	...
	function exports(){
		...
		if(idArr>10000){
			$('body').popup({
				...
				content:content,
				 fnConfirm :function(){
					 location.href="${ctx}/statistic/exportsStock?"+$("#cx").serialize()+"&formPath=/a/statistic/stockStatUsed";
				 }
