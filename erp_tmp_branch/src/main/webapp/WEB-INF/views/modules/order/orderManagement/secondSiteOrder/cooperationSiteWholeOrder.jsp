		...
		<div class="tabCon">
			...
			<div class="pt-10 pb-5 cl">
				<div class="f-l">
					 ...
					 <sfTags:pagePermission authFlag="ORDERMGM_HZSITE_WXORDER_BTN" html='<a href="javascript:showwxgd();" class="sfbtn sfbtn-opt"><i class="sficon sficon-invalid"></i>无效工单</a>'></sfTags:pagePermission> 
				</div>
				<div class="f-r">
...
function showDetail(id,siteId){
	...
	batchFormIndex =layer.open({
		type : 2,
		content:'${ctx}/secondOrder/secondWaitDealOrderForm?id='+id+'&siteId='+siteId+'&siteType=11',
		title:false,
		area: ['100%','100%'],
		closeBtn:0,
		shade:0,
...
var disPmark=false;
	...
	function insertIntoChangeConditions(operationType){
