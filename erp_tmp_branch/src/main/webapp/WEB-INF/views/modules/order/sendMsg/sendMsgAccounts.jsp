...
<body>
		...
		<div class="popupContainer" style="height: 420px; overflow: auto;">
			<div class="popupMain pd-20" id="msgWrap">
				...
				<div class="tabCon">
					...
					<div id="smq" class=" sysModel">
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								<span class="lb w-70 text-c">
									发送内容：
									<span class="c-0383dc">（模板一）</span>
								</span>
								<div class="bk-gray pd-10">
									<input type="text" class="msg-input" id="custName" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 您的
									<input type="text" class="msg-input" id="yw" value="${order.serviceType }" onkeyup="inputWidth(this)" />
									业务
									<input type="text" class="msg-input" id="siteName" value="${siteName }" onkeyup="inputWidth(this)" />
									已受理，
						...
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								<span class="lb w-70 text-c">
									发送内容：
									<span class="c-0383dc">（模板二）</span>
								</span>
								<div class="bk-gray pd-10">
									尊敬的用户：您的信息
									<input type="text" class="msg-input" id="custNameMobile" value="${siteName }(${jdPhone }) " onkeyup="inputWidth(this)" />
									已经派工，服务工程师
									<input type="text" class="msg-input" id="emName" value="${msg2Names }" onkeyup="inputWidth(this)" />
									， 联系电话
									<input type="text" class="msg-input" id="emMobile" value="${msg2Mobiles }" onkeyup="inputWidth(this)" />
									， 请您对我们的服务进行监督！ 【
					...
					<div id="zzcp" hidden="hidden" class="sysModel">
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									尊敬的
									<input type="text" readonly="readonly" class="msg-input" id="custName" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 您的
									<input type="text" readonly="readonly" class="msg-input" id="yw" value="${order.serviceType }" onkeyup="inputWidth(this)" />
									业务，我司已受理， 指派
									<input type="text" readonly="readonly" class="msg-input" value="${msg1 }" onkeyup="inputWidth(this)" />
									为您服务，
									<input type="text" readonly="readonly" class="msg-input" id="mode1" value="注意用电安全请点击${oneHref }">
									，详情咨询上门工程师。 【
						...
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									尊敬的
									<input type="text" class="msg-input" readonly="readonly" id="custName" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 您的
									<input type="text" class="msg-input" readonly="readonly" id="yw" value="${order.serviceType }" onkeyup="inputWidth(this)" />
									业务，我司已受理， 指派
									<input type="text" class="msg-input" readonly="readonly" value="${msg1 }" onkeyup="inputWidth(this)" />
									为您服务，
									<input type="text" class="msg-input" readonly="readonly" id="mode2" value="另有专用自动止水水龙头和底座，可有效防止漏水和延长家电使用寿命">
									，详情咨询上门工程师。 【
						...
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									...
									<input type="text" class="msg-input" readonly="readonly" value="${msg1 }" onkeyup="inputWidth(this)" />
									为您服务，
									<input type="text" class="msg-input" readonly="readonly" id="mode3" value="另有安全用电家电伴侣产品等为您提供试用，使您拥有最安心的家电使用体验，">
									<input type="text" class="msg-input" readonly="readonly" id="mode4" value="洗衣机专用自动止水水龙头和洗衣机底座，可有效防止水淹事故导致财产损失，延长家电安全使用寿命">
									，详情咨询上门工程师。 【
						...
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									...
									<input type="text" class="msg-input" readonly="readonly" id="siteMobile" value="${jdPhone }" onkeyup="inputWidth(this)" />
									或服务工程师电话
									<input type="text" class="msg-input" readonly="readonly" value="${msg1 }" onkeyup="inputWidth(this)" />
									, 我们将尽快为您提供满意的服务！ 【
					...
					<div id="pjwrjd" hidden="hidden" class="sysModel">
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									你好，你购买的商品
									<input type="text" class="msg-input" readonly="readonly" id="goodsTime" value="今天" onkeyup="inputWidth(this)" />
									到
									<input type="text" class="msg-input" readonly="readonly" value="${siteArea }" id="pjArea" onkeyup="inputWidth(this)" />
									,联系你电话无人接听，看到短信后请联系
									<input type="text" class="msg-input" readonly="readonly" value="${siteMobile }" id="pjMobile" onkeyup="inputWidth(this)" />
									。 【
					...
					<div id="gyemp" hidden="hidden" class="sysModel">
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								<span class="lb w-70 text-c">发送内容：</span>
								<div class="bk-gray pd-10">
									<input type="text" class="msg-input" readonly="readonly" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 您的预约时间已改至
									<input type="text" readonly="readonly" class="msg-input" id="proTime" value="${proTime } " onkeyup="inputWidth(this)" />
									，
									<input type="text" class="msg-input" readonly="readonly" id="promiseLimit" value="${order.promiseLimit }" onkeyup="inputWidth(this)" />
									， 具体上门时间，
									<input type="text" class="msg-input" readonly="readonly" value="${msg1}" onkeyup="inputWidth(this)" />
									， 会与您联系的，监督电话：
									<input type="text" readonly="readonly" class="msg-input" value="${jdPhone }" onkeyup="inputWidth(this)" />
									。 【
					...
					<div id="qjpj" hidden="hidden" class="sysModel">
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									<input type="text" class="msg-input" readonly="readonly" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 因店内配件无库存，现已紧急调度，配件到位后，具体上门时间，
									<input type="text" class="msg-input" readonly="readonly" value="${msg1}" onkeyup="inputWidth(this)" />
									， 会与您联系的，监督电话：
	...
	<div class="popupBox massTextNote massTextNoteQf">
		...
		<div class="popupContainer">
			<div class="popupMain ">
				<div class="f-14">
					您已发送
					<strong class="c-005aab" id="sucMsg">0</strong>
					条，未发送
					<strong class="c-fd7e2a" id="wroMsg">0</strong>
					条！
				</div>
				<a id="exportLink" onclick="closePopup()" href="${ctx}/order/exportWrongNumberDuring?formPath=/a/order/during" target="_blank" class="c-0383dc mt-10"
					style="text-decoration: underline;">查看发送失败的工单</a>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#sendModel1").append(
					'<input type="button" href="javascript:;"  class="sfbtn sfbtn-green readonly w-70 btn-sendmsg" onclick=sendModel1("2","6","' + content1 + '") value="发送" />');
			$("#sendModel2").append(
					'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick=sendModel1("3","6","' + content2 + '") value="发送" />');
			resetData();
			$(".msgText1").popup();
		})
					...
					success : function(result) {
						...
						if (tag == '6') {//上门前
							...
							if (result[0].columns.id == 2) {
								$("#sendModel1").append(
										'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\'' + result[0].columns.id
												+ '\',\'' + result[0].columns.tag + '\',\'' + result[0].columns.content + '\',3)" value="发送" />');
							} else {
								$("#sendModel1").append(
										'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\'' + result[1].columns.id
												+ '\',\'' + result[1].columns.tag + '\',\'' + result[1].columns.content + '\',3)" value="发送" />');
							}
						...
						if (tag == '7') {//增值产品
							...
							$("#sendModel3").append(
									'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\'' + result[0].columns.id + '\',\''
											+ result[0].columns.tag + '\',\'' + result[0].columns.content + '\',1)" value="发送" />');
							$("#sendModel4").append(
									'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\'' + result[0].columns.id + '\',\''
											+ result[0].columns.tag + '\',\'' + result[0].columns.content + '\',2)" value="发送" />');
							$("#sendModel5").append(
									'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\'' + result[0].columns.id + '\',\''
											+ result[0].columns.tag + '\',\'' + result[0].columns.content + '\',0)" value="发送" />');
						}
						if (tag == '4') {//电话无人接听
							$("#dhwrjd").show();
							$("#sendModel6").append(
								...
								if (result != "" || result != null) {
									...
									while (newcontent.indexOf('@1') >= 0) {
										newcontent = newcontent
												.replace("@1",
														"<input type='text' class='msg-input' readonly='readonly'  value='${order.customerName }' onkeyup='inputWidth(this)' id='defcustomerName'/>");
									}
									while (newcontent.indexOf('@2') >= 0) {
										newcontent = newcontent
												.replace("@2",
														"<input type='text' class='msg-input' readonly='readonly'  value='${order.applianceBrand }' onkeyup='inputWidth(this)' id='defapplianceBrand'/>");
									}
									while (newcontent.indexOf('@3') >= 0) {
										newcontent = newcontent
												.replace("@3",
														"<input type='text' class='msg-input' readonly='readonly' value='${order.applianceCategory }' onkeyup='inputWidth(this)' id='defapplianceCategory'/>");
									}
									while (newcontent.indexOf('@4') >= 0) {
										newcontent = newcontent
												.replace("@4",
														"<input type='text' class='msg-input' readonly='readonly' value='${order.serviceType }' onkeyup='inputWidth(this)' id='defserviceType'/>");
									}
									while (newcontent.indexOf('@5') >= 0) {
										if ('${order.serviceMode }' == '1') {
											newcontent = newcontent.replace("@5",
													"<input type='text' class='msg-input' readonly='readonly'  value='上门' onkeyup='inputWidth(this)' id='defserviceMode'/>");
										} else if ('${order.serviceMode }' == '2') {
											newcontent = newcontent.replace("@5",
													"<input type='text' class='msg-input' readonly='readonly'  value='拉修' onkeyup='inputWidth(this)' id='defserviceMode'/>");
										} else {
											newcontent = newcontent.replace("@5",
													"<input type='text' class='msg-input' readonly='readonly' value='' onkeyup='inputWidth(this)' id='defserviceMode'/>");
										}
									}
									while (newcontent.indexOf('@6') >= 0) {
										newcontent = newcontent.replace("@6",
												"<input type='text' class='msg-input' readonly='readonly' value='${msg2Names}' onkeyup='inputWidth(this)' id='defmsg2Names'/>");
									}
									while (newcontent.indexOf('@7') >= 0) {
										newcontent = newcontent
												.replace("@7",
														"<input type='text' class='msg-input' readonly='readonly' value='${msg2Mobiles }' onkeyup='inputWidth(this)' id='defmsg2Mobiles'/>");
									}
									while (newcontent.indexOf('@8') >= 0) {
										newcontent = newcontent.replace("@8",
												"<input type='text' class='msg-input' readonly='readonly' value='${site.smsPhone }' onkeyup='inputWidth(this)' id='defjdPhone'/>");
									}
									$(".defmsgcontent").append('<span class="lb w-70 text-c">发送内容：</span><div class="bk-gray pd-10">' + newcontent + '</div>');
									$("#sendModel").append(
											'<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModeldef(\'' + result.columns.id
													+ '\',\'' + result.columns.tag + '\',\'' + result.columns.content + '\',2)" value="发送" />');
		...
		function senMsg() { //批量发送短信
			...
			var wrongNumber = "";
			var showCustomers = "";
			var ids = parent.getMsgToChildPageArr("").ids;
			for (var i = 0; i < ids.length; i++) {
				var rowData = parent.getMsgToChildPageArr(ids[i]).data;
				;
				var ph1 = returnMobile(rowData.customer_mobile.split(',')[0]);//去空格的mobile
			...
			$.ajax({
				...
				success : function(result) {
					if (parseInt(result) * parseInt(msgNums) > parseInt(siteMsgNums)) {
						...
						$("#clickSend").append(
								'<a href="javascript:;" class="sfbtn sfbtn-opt3 w-70  " onclick="sendAllConfirm(\'' + sign + '\',\'' + mobile + '\',\'' + number
		...
		var aflTS = false;
		function sendModel1(id, tag, content, mode) {//系统模板-发送短信
			$("#clickSend").empty();
			if (aflTS) {
				return;
			}
			var ids = parent.getMsgToChildPageArr("").ids;
			var mark = parent.getMsgToChildPageArr("").mark;
			var mobile = "";
			var number = "";
			var yxId = "";
			var wrongNumber = "";
			...
			if (id == 2) {//模板一
				...
				s_temp = content.substring(0, path_1) + custName + content.substring(path_1 + 1, path_2) + yw + content.substring(path_2 + 1, path_3) + siteName
						+ content.substring(path_3 + 1, path_4) + emNameMobile + content.substring(path_4 + 1, path_5) + jdMobile
						// + content.substring(path_5 + 1, path_6) + sign
						+ content.substring(path_5 + 1);

			} else if (id == 3) {//模板二
				if ($.trim($("#sign2").text()) == "" || $("#sign2").val() == null) {
					layer.msg("短信签名不能为空！");
					$("#sign2").focus();
					return;
				}
				...
				s_temp = content.substring(0, path_1) + custNameMobile + content.substring(path_1 + 1, path_2) + emName + content.substring(path_2 + 1, path_3) + emMobile
				...
				s_temp = content.substring(0, path_1) + siteMobile + content.substring(path_1 + 1, path_2) + emNameMobile
				...
				s_temp = content.substring(0, path_1) + goodsTime + content.substring(path_1 + 1, path_2) + pjArea + content.substring(path_2 + 1, path_3) + pjMobile
				// + content.substring(path_3 + 1, path_4) + sign
				+ content.substring(path_3 + 1);
			} else if (id == 5) {//改约
				...
				s_temp = content.substring(0, path_1) + custName + content.substring(path_1 + 1, path_2) + proTime + content.substring(path_2 + 1, path_3) + promiseLimit
						+ content.substring(path_3 + 1, path_4) + emNameMobile + content.substring(path_4 + 1, path_5) + jdMobile
						// + content.substring(path_5 + 1, path_6) + sign
						+ content.substring(path_5 + 1);
			} else if (id == 6) {//缺件
				...
				s_temp = content.substring(0, path_1) + custName + content.substring(path_1 + 1, path_2) + emNameMobile + content.substring(path_2 + 1, path_3) + jdMobile
				// + content.substring(path_3 + 1, path_4) + sign
				+ content.substring(path_3 + 1);
			} else if (id == 9) {
				if (mode == "1") {
					...
					s_temp = content.substring(0, path_1) + custName + content.substring(path_1 + 1, path_2) + yw + content.substring(path_2 + 1, path_3) + emNameMobile
			...
			$.ajax({
				...
				success : function(result) {
					if (parseInt(result) * parseInt(msgNums) > parseInt(siteMsgNums)) {
						...
						$("#clickSend").append(
								'<a href="javascript:;" class="sfbtn sfbtn-opt3 w-70  " onclick="sendConfirmMsgModel(\'' + id + '\',\'' + sign + '\',\'' + s_temp + '\',\'' + tag
										+ '\',\'' + number + '\',\'' + mobile + '\',\'' + yxId + '\',\'' + endMode + '\')" >确定</a>&nbsp;&nbsp;'
		...
		var aflModel = false;
		function sendConfirmMsgModel(id, sign, s_temp, tag, number, customerMobile, yxId, endMode) {//系统模板-发送短信
			if (aflModel) {
				return;
			}
			...
			$.ajax({
				type : "POST",
				url : "${ctx }/order/fwzSendmsgModelFwz",
				data : {
					temId : id,
					sign : sign,
					content : s_temp,
		...
		function sendModeldef(id, tag, content, markType) {
			...
			$.ajax({//check短信为几条，并对比看服务商已购买短信够不够发送
				...
				success : function(result) {
					if (parseInt(result) * parseInt(msgNums) > parseInt(siteMsgNums)) {//发送短信数大于购买数
						layer.msg("剩余可发送短信条数不足，请先购买后在发送！");
					} else {
						$("#peoples").html(showCustomers);
						$("#sendContent").text("“" + s_temp + "”？");
						$("#clickSend").append(
								'<a href="javascript:;" class="sfbtn sfbtn-opt3 w-70  " onclick="sendConfirmMsgModelDefined(\'' + id + '\',\'' + sign + '\',\'' + s_temp + '\',\''
										+ tag + '\',\'' + number + '\',\'' + mobile + '\',\'' + yxId + '\',\'' + markType + '\')" >确定</a>&nbsp;&nbsp;'
										+ '<a href="javascript:;" class="sfbtn sfbtn-opt w-70" id="cancelQuren" onclick="cancelQueren()">取消</a>');
						$(".msgTextQuren").popup({
							level : 2,
							closeSelfOnly : true
