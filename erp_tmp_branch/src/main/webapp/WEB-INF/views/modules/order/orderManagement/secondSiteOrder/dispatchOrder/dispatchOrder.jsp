    ...
    <div class="popupContainer">
        <div class="pcontent">
            <div class="popupMain pl-15 pt-5 pb-15">
                <div class="searchEr">
                    <input type="text" style="height:100%;" id="searchName" placeholder="请输入二级网点"><img src="${ctxPlugin}/static/h-ui.admin/images/search.png" alt="">
                ...
                <p class="surePush"><span class="mark">指派至：</span><span id="dispatchPeople"></span></p>
                <div class="text-c ">
                    <a href="javascript:dispatchOrderSave();" class="sfbtn sfbtn-opt3 w-100">确认指派</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
	...
	function dispatchOrderSave(){
		...
		$.ajax({
			type:"post",
			data:postData,
			url:"${ctx}/secondOrder/dispatchOrderSave",
			success:function(result){
				if(result=='200'){
					if('${position}'=='2'){
						parent.parent.parent.layer.msg("派工成功！");
						parent.parent.search();
					}else{
						parent.parent.layer.msg("派工成功！");
						parent.search();
					}
					$.closeAllDiv();
				}else if(result=="420"){
