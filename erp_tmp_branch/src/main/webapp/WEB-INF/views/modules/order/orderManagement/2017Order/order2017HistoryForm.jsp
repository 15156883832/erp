    ...
    <div class="popupContainer pos-r">
        <div class="popupMain pos-r" >
            <div class="pcontent">
                <div id="detialWd">
                    ...
                    <form id="updateOrder" method="post" >
                        ...
                        <input type="hidden" name= "siteId" value="${order.siteId }">
                        <div class="tabCon">
                            <div class="cl mb-15 mt-10">
                                ...
                                <div class="f-l pos-r pl-80">
                                    <label class="lb w-80">服务方式：</label>
						...
						<div class="f-l pos-r " style="padding-left: 15px;">
                            ...
                            <div class="cl mt-10">
                                ...
                                <div class="f-l pos-r pl-80">
                                    ...
                                    <%-- <input type="text" class="input-text w-130 readonly remarkUpdate" readonly="readonly"  value="${order.promiseLimit }"/> --%>
                                </div>
                            </div>
                            <div class="cl mt-10">
                            ...
                            <div class="cl mt-10">
                                ...
                                <div class="f-l pos-r pl-100">
                                    ...
                                    <%--<label class="lb w-100 text-r"><c:if test="${mustfill.columns.pleaseReferMall}"><em class="mark"></em></c:if>购机商场：</label>
                                    <input type="text" name="pleaseReferMall" class="input-text w-120 readonly remarkUpdate" readonly="readonly" value="${order.pleaseReferMall}">--%>
                                </div>
                                <div class="f-l pos-r txtwrap2 wrapss">
					...
					<div class="processWrap">
						<div id="Imgprocess1">
								<c:forEach items="${bdImgs }" var="str" varStatus="da">
            ...
            <div class="btnMenubox pb-80">
				...
				<sfTags:pagePermission authFlag="ORDER_HISTORYORDER_FINISHORDER_ALLEDIT_BTN" html='<input class="sfbtn sfbtn-opt sbtn caozuo" type="button" value="修改" onclick="updateHistory(\'${order.id}\')" />'></sfTags:pagePermission>
				</c:if>
                ...
                <input class="sfbtn sfbtn-opt other" value="新建工单" type="button" onclick="newOrder('${order.id}')"/>
...
//		$("#addJsForm").get(0).reset();
            ...
            success: function (data) {
                if ("T" === data) {
                    openedJiesuanFormIndex = layer.open({
                        type: 2,
                        content: '${ctx}/order/settlement/edit2017?id=${order.id}'+'&mode='+modes+'&markIf=redirect',
                        title: false,
                        area: ['100%', '100%'],
                        closeBtn: 0,
                        shade: 0,
    ...
    function closeJiesuanForm() {
        ...
        $("#settlementDetail").load("${ctx}/order/settlement/showHtml2017?id=${order.id}&v=" + new Date().getTime());
        parent.search();
    }
...
//			tipSweep: true,
    ...
    $("#settlementDetail").load("${ctx}/order/settlement/showHtml2017?id=${order.id}");
    $('#Imgprocess2').imgShow();
    ...
    function updateHistory(id){
        ...
        if(caozuo == '修改'){
            ...
            if(chongfu){
                ...
                $.ajax({
                    url:"${ctx}/order2017/orderDispatch/updateHistoryUser",
