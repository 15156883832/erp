...
<div class="page-orderWait">
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl mb-10">
			...
			<sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_TAB" html='<a class="btn-tabBar current" href="${ctx }/order/getWwgList/djgd">待件工单<sup id="tab_c4">0</sup></a>'></sfTags:pagePermission>
			<p class="f-r btnWrap">
		...
		<div class="tabCon">
				...
				<div class="bk-gray pt-10 pb-5">
					<table class="table table-search">
						...
						<tr>
							...
							<td>
								<span class="w-140">
									<select class="easyui-combobox" id="statusFlag" panelMaxHeight="55px" multiple="true" multiline="false" labelPosition="top" name="statusFlag" style="width:100%;height:25px">
							...
							<td id="reloadSpan">
								<span class="w-140 dropdown-sin-2" >
									<select class="select-box w-120"  multiple id="employs"    name="employeNames"  style="width:140px">
			...
			<div class="pt-10 pb-5 cl">
				<div class="f-l">
					<sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_ZPORDER_BTN" html='<a href="javascript:Turntosend();" class="sfbtn sfbtn-opt"><i class="sficon sficon-turnorder"></i>转派</a>'></sfTags:pagePermission>
					<sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_WXORDER_BTN" html='<a href="javascript:showwxgd();" class="sfbtn sfbtn-opt"><i class="sficon sficon-invalid"></i>无效工单</a>'></sfTags:pagePermission>
				...
				<div class="f-r">
					...
					<%-- <sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_IMPORT_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2"><i class="sficon sficon-import"></i>导入</a>'></sfTags:pagePermission> --%>
					<sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_EXPORT_BTN" html='<a onclick="return exports()" class="sfbtn sfbtn-opt2" target="_blank"><i class="sficon sficon-export"></i>导出</a>'></sfTags:pagePermission>
					<sfTags:pagePermission authFlag="ORDERMGM_DURINGORDER_DAIJIANORDER_TBSETTLE_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2" id="setHeadersBtn"><i class="sficon sficon-setting"></i>表头设置</a>'></sfTags:pagePermission>
				</div>
...
function initSfGrid(){
	$("#table-waitdispatch").sfGrid({
		url : '${ctx}/order/getOrderMenuList/djgd?ptype='+${ptype},
...
function exports(){
	...
	if(idArr>10000){
		$('body').popup({
			...
			content:content,
			 fnConfirm :function(){
				 location.href="${ctx}/order/export?formPath=/a/order/getWwgList/djgd&&maps="+$("#searchForm").serialize();
			 },
				fnCancel: function () {
