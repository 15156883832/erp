	...
	<div class="popupContainer pos-r">
		<div class="popupMain">
			...
			<input type="hidden"  value="${serviceMode.columns.id }"  id="ids"/>
				...
				<input type="text" class="input-text w-140 f-l labelsort" value="${serviceMode.columns.sort }"/>
			</div>
			</div>
...
<script type="text/javascript">
	...
	var ids=document.getElementById("ids").value;
		...
		$.ajax({
			type:'POST',
			url:'${ctx}/order/serviceMode/queryNums',
			traditional: true,
			data:{"names":names,
				     "id":ids}, 
			dataType:'json',
			...
			if(result.flag){
				$.ajax({
					type:'POST',
					url:"${ctx}/order/serviceMode/update",
					traditional: true,
					data:{
						"names":names,
					    "sorts":sorts,
