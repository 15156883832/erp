					...
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.aokesi eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_TAB"
								html='<a id="aokesi" class="btn-tabBar current"  href="${ctx }/order/ChangeSelfOrder/aokesiHeaderList">奥克斯工单</a>'></sfTags:pagePermission>
						</c:if>
	...
	<script type="text/javascript">
		...
		function initSfGrid() {
			$("#table-waitdispatch").sfGrid({
				url : '${ctx}/order/ChangeSelfOrder/FourAokesiOrder',
				sfHeader : defaultHeader,
				sfSortColumns : sortHeader,
				rownumbers : true,
		...
		function exports() {
			...
			if (idArr > 10000) {
				$('body').popup({
					...
					content : content,
					fnConfirm : function() {
						location.href = "${ctx}/order/ChangeSelfOrder/exportAokesi?formPath=/a/order/ChangeSelfOrder/aokesiHeaderList&&maps=" + $("#searchForm").serialize();
					}
				});
			} else {
				location.href = "${ctx}/order/ChangeSelfOrder/exportAokesi?formPath=/a/order/ChangeSelfOrder/aokesiHeaderList&&maps=" + $("#searchForm").serialize();
