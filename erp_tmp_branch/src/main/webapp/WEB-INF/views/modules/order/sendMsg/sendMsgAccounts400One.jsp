		...
		<div class="popupMain pd-20" id="msgWrap" >
			...
			<div class="tabCon">
				<div class="pos-r pl-70 mt-10">
						...
						<div class="msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									...
									您的<input type="text" class="msg-input"  value="${serviceType }"  onkeyup="inputWidth(this)"/>业务
							...
							<div class="pos-r pl-70 pr-80 mt-10">
								...
								<div class="bk-gray pd-10">
									...
									<input type="text" class="msg-input"  value="${serviceType }"  onkeyup="inputWidth(this)"/>服务！
					...
					<div id="hfdx" hidden="hidden" class="sysModel">
						<div class=" msgmould">
							<div class="pos-r pl-70 pr-80 mt-10">
								<span class="lb w-70 text-c">发送内容：</span>
								<div class="bk-gray pd-10">
	    ...
	    if(reds=="1"){
	    	$.ajax({
				...
				success:function(result){
					...
					if(tag=='5'){//回访
						$("#hfdx").show();
						$("#sendModelD3").append('<input type="button" href="javascript:;" class="sfbtn sfbtn-green w-70 btn-sendmsg" onclick="sendModel1(\''+result[0].columns.id+'\',\''+result[0].columns.tag+'\',\''+result[0].columns.content+'\',3)" value="发送" />');
					}
					resetData();
					return;
				}
...
function sendConfirmMsgModelDefined(id,sign,s_temp,tag,number,customerMobile,yxId,markType){
	...
	$.ajax({
		type:"POST",
		url:"${ctx }/order/fwzSendmsgModelFwzDefined1400",
		data:{temId:id,
			sign:sign,
			content:s_temp,
			extno:tag,
