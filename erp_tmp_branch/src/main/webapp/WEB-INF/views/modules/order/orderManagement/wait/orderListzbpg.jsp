...
<div class="page-orderWait">
		...
		<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_TAB" html='<a class="btn-tabBar current"  href="${ctx }/order/getWwgList/zbpg">暂不派工<sup id="tab_c2">0</sup></a>'></sfTags:pagePermission>
		...
		<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_JRYYORDER_TAB" html='<a class="btn-tabBar" href="${ctx }/order/getWwgList/jryy">今日预约<sup id="tab_c4">0</sup></a>'></sfTags:pagePermission>
			...
			<div class="pt-10 pb-5 cl">
				<div class="f-l">
				<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_NEWORDER_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt" onclick="addNew();"><i class="sficon sficon-add"></i>新建工单</a>'></sfTags:pagePermission>
				<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_DISPATCH_BTN" html='<a href="javascript:directDis();" class="sfbtn sfbtn-opt"><i class="sficon sficon-dispatch"></i>派工</a>'></sfTags:pagePermission>
				<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_ZBDISPATCH_BTN" html='<a href="javascript:emporarily();" class="sfbtn sfbtn-opt"><i class="sficon sficon-notdispatch"></i>暂不派工</a>'></sfTags:pagePermission>
				<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_WXORDER_BTN" html='<a href="javascript:showwxgd();" class="sfbtn sfbtn-opt"><i class="sficon sficon-invalid"></i>无效工单</a>'></sfTags:pagePermission>
				...
				<div class="f-r">
					...
					<%-- <sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_IMPORT_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2"><i class="sficon sficon-import"></i>导入</a>'></sfTags:pagePermission> --%>
					<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_EXPORT_BTN" html='<a  onclick="return exports()"class="sfbtn sfbtn-opt2" target="_blank"><i class="sficon sficon-export"></i>导出</a>'></sfTags:pagePermission>
					<sfTags:pagePermission authFlag="ORDERMGM_WAITDISPATCH_ZANBUPAIGONG_TBSETTLE_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2" id="setHeadersBtn"><i class="sficon sficon-setting"></i>表头设置</a>'></sfTags:pagePermission>
				</div>
...
function initSfGrid(){
	$("#table-waitdispatch").sfGrid({
		url : '${ctx}/order/getOrderMenuList/zbpg?ptype='+${ptype},
		sfHeader: defaultHeader,
		sfSortColumns: sortHeader,
		rownumbers:true,
   ...
   /*  if (nowM >= start && nowM <= end) {
	...
	if(idArr>10000){
		$('body').popup({
			...
			content:content,
			 fnConfirm :function(){
				 location.href="${ctx}/order/export?formPath=/a/order/getWwgList/zbpg&&maps="+$("#searchForm").serialize();
			 },
			fnCancel: function () {
