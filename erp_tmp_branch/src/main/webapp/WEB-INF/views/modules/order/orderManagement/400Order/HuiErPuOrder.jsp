				...
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.huierpu eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUIERPU_TAB"
								html='<a id="huierpu" class="btn-tabBar current"  href="${ctx }/order/ChangeSelfOrder/huierpuHeaderList">惠而浦工单</a>'></sfTags:pagePermission>
						</c:if>
					...
					<div class="tabCon">
										...
										<td id="reloadSpan">
											<span class="dropdown-sin-2 w-140">
												<select class="select" name="status" id="status" multiple>
													<option value="已派至网点">已派至网点</option>
						...
						<div class="pt-10 pb-5 cl">
							<div class="f-l">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHUIERPU_ZHUANZIJIE_BTN"
									html='<a href="javascript:;" class="sfbtn sfbtn-opt" onclick="zzj();"><i class="sficon sficon-zzj"></i>转自接</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHUIERPU_DELETEMORE_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHUIERPU_PILIANGPRINT_BTN"
							...
							<div class="f-r">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHUIERPU_EXPORT_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHUIERPU_HEADSET_BTN"
	...
	<script type="text/javascript">
		...
		function initSfGrid() {
			$("#table-waitdispatch").sfGrid({
				url : '${ctx}/order/ChangeSelfOrder/FourHuierpuOrder',
				sfHeader : defaultHeader,
				sfSortColumns : sortHeader,
				rownumbers : true,
		...
		function exports() {
			...
			if (idArr > 10000) {
				$('body').popup({
					...
					content : content,
					fnConfirm : function() {
						location.href = "${ctx}/order/ChangeSelfOrder/exportHuierpu?formPath=/a/order/ChangeSelfOrder/huierpuHeaderList&&maps=" + $("#searchForm").serialize();
					}
				});
			} else {
				location.href = "${ctx}/order/ChangeSelfOrder/exportHuierpu?formPath=/a/order/ChangeSelfOrder/huierpuHeaderList&&maps=" + $("#searchForm").serialize();
