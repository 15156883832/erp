				...
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.tcl eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_TAB"
								html='<a id="tcl" class="btn-tabBar current "  href="${ctx }/order/ChangeSelfOrder/tclHeaderList">TCL工单</a>'></sfTags:pagePermission>
						</c:if>
					...
					<div class="tabCon">
										...
										<td>
											<span class="w-140">
												<select class="select easyui-combobox" id="statusFlag" multiple="true" multiline="false" name="status" style="width: 100%; height: 25px" panelMaxHeight="300px">
													...
													<option value="已回过程单">已回过程单</option>
						...
						<div class="pt-10 pb-5 cl">
							<div class="f-l">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_ZZJ_BTN"
									html='<a href="javascript:;" class="sfbtn sfbtn-opt" onclick="zzj();"><i class="sficon sficon-zzj"></i>转自接</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_PLDELETE_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_MARKORDER_BTN"
									html='<a href="javascript:showMarkOrders();" class="sfbtn sfbtn-opt"><i class="sficon sficon-sign"></i>标记工单</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_CANCELMARK_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_PLPRINT_BTN"
							...
							<div class="f-r">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_EXPORT_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_TCLORDER_HEADERSET_BTN"
	...
	<script type="text/javascript">
		...
		function initSfGrid() {
			$("#table-waitdispatch").sfGrid({
				url : '${ctx}/order/ChangeSelfOrder/FourTclOrder',
				sfHeader : defaultHeader,
				sfSortColumns : sortHeader,
				rownumbers : true,
		...
		function exports() {
			...
			if (idArr > 10000) {
				$('body').popup({
					...
					content : content,
					fnConfirm : function() {
						location.href = "${ctx}/order/ChangeSelfOrder/exportTcl?formPath=/a/order/ChangeSelfOrder/tclHeaderList&&maps=" + $("#searchForm").serialize();
					}
				});
			} else {
				location.href = "${ctx}/order/ChangeSelfOrder/exportTcl?formPath=/a/order/ChangeSelfOrder/tclHeaderList&&maps=" + $("#searchForm").serialize();
