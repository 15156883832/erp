			...
			<div class="page-orderWait">
					...
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.haixin eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HAIXINORDER_TAB"
								html='<a id="haixin" class="btn-tabBar current"  href="${ctx }/order/ChangeSelfOrder/haixinHeaderList">海信工单</a>'></sfTags:pagePermission>
						</c:if>
				...
				--%>
						...
						<div class="pt-10 pb-5 cl">
							<div class="f-l">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHAIXIN_DELETEMORE_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHAIXIN_PILIANGPRINT_BTN"
							...
							<div class="f-r">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHAIXIN_EXPORT_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HUNDRANDORDERHAIXIN_HEADSET_BTN"
