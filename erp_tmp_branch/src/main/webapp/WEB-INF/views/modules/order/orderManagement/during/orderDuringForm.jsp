...
<body>
		...
		<div class="popupContainer">
			<div class="popupMain pos-r">
							...
							<div class="tabCon">
								...
								<div class="cl mt-10">
									...
									<div class="f-l pos-r pl-100">
										...
										<input type="text" id="customerMobile" class="input-text w-110 readonly" readonly="readonly" name="customerMobile" value="${order.customerMobile }" />
									</div>
								...
								<div class="cl mt-10 mb-10">
									<div class="pos-r pl-100" id="pcd">
										...
										<input type="text" class="input-text w-280 f-l readonly" readonly="readonly" id="customerAddress1" name="customerAddress1" value="${fns:ej(order.customerAddress) }"
											autocomplete="off" />
										<input type="hidden" id="customerAddress" name="customerAddress" value="${fns:ej(order.customerAddress)}" />
								...
								<div class="cl mt-10">
									<div class="f-l pos-r pl-100">
										...
										<input id="buyDate" type="text" onfocus="WdatePicker({maxDate: '%y-%M-%d' })" class="input-text w-160 readonly" disabled="disabled" name="applianceBuyTime"
											value="<fmt:formatDate value='${order.applianceBuyTime }' pattern='yyyy-MM-dd'/>" />
									</div>
									<div class="f-l pos-r pl-100">
										<c:choose>
							...
							<div class="cl mt-10">
								...
								<c:if test="${not empty collectionslist}">
									...
									<div class="f-l lh-26">
										<div>
											无现金收款：${sum}元
											<a class="proofImg c-0383dc" id="imgshows">
												凭证
												<c:forEach items="${collectionslist}" var="col">
				...
				<div class="btnMenubox pb-80">
					...
					<sfTags:pagePermission authFlag="ORDER_ZHUANPAI_BTN_OTHERS"
						html='<input class="sfbtn sfbtn-opt sbtn" id="zp" value="转派" type="button" onclick="Turntosend(\'${order.customerLnglat}\',\'${fns:ej(order.customerAddress)}\')"/>'></sfTags:pagePermission>
					<%--<input class="sfbtn sfbtn-opt sbtn" value="反馈封单" id="btn-fbOrder" type="button" />--%>
								...
								<div>
									...
									<div class="cl mt-10">
										<div class="f-l pos-r txtwrap1">
											...
											<input type="text" class="input-text" style="width: 534px;" value="${order.malfunctionType}" id="malfunctionType1" name="malfunctionType" />
										</div>
									</div>
					...
					<div class="mt-5 serverlistWrap">
								...
								<thead>
									...
									<th class="w-100">
										...
										<i class="Hui-iconfont f-20 c-fe0101 mr-5 left_tip_">
											&#xe6cd;
											<span class="tip__" style="width: 380px;">
												<em class="left_tip"></em>
												统计今日派工且未预约以及预约时间为今日的工程师未完工工单数量
											</span>
										</i>
									</th>
						...
						<div class="serversName">
							<div class="txtwrap1 pos-r">
								<label class="lb lb1" style="width: 75px;">
									<em class="mark">*</em>
									转派原因：
								</label>
				...
				<div class="f-r w-460">
					<div class="cl mb-10">
						...
						<div class="f-l w-230 ml-10 f-13 pt-10" style="height: 120px;">
							<p class="">
								<strong class="custNam">${order.customerName}</strong>
							</p>
							<p class="">
								<strong class="custMob">${order.customerMobile}</strong>
							</p>
							<p class="custAddr">${order.province}${order.city}${order.area}${fns:ej(order.customerAddress)}</p>
						</div>
					</div>
					<div class="cl mb-10">
						<input type="text" class="input-text w-330 f-l" id="arroundCustomerAddress" />
						<a class="sfbtn sfbtn-opt f-r" href="javascript:searchArroundCust();">
					...
					<div class="serverlistWrap">
						...
						<div class="serversName">
							<div class="pos-r pl-15 pr-80">
								<p class="pt-5 pb-5 lh-20" style="min-height: 30px">
									<%--郑经文、小灰灰、张晓明郑经文、小灰灰、张晓明--%>
								</p>
				...
				<div class="tabCon">
					...
					<div class="msgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign1" onkeyup="inputWidth(this)" />
								服务】
							</div>
						...
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								， 请您对我们的服务进行监督！ 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign2" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="msgmould hide">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								为您服务，
								<input type="text" class="msg-input" id="mode1" value="注意用电安全请点击${oneHref }">
								，详情咨询上门工程师。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign10" onkeyup="inputWidth(this)" />
								服务】
							</div>
						...
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								<input type="text" class="msg-input" value="${msg1 }" onkeyup="inputWidth(this)" />
								为您服务，
								<input type="text" class="msg-input" id="mode2" value="另有专用自动止水水龙头和底座，可有效防止漏水和延长家电使用寿命">
								，详情咨询上门工程师。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign11" onkeyup="inputWidth(this)" />
								服务】
							</div>
						...
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								<input type="text" class="msg-input" id="mode4" value="洗衣机专用自动止水水龙头和洗衣机底座，可有效防止水淹事故导致财产损失，延长家电安全使用寿命">
								，详情咨询上门工程师。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign12" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="hide msgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								<input type="text" class="msg-input" value="${msg1 }" onkeyup="inputWidth(this)" />
								, 我们将尽快为您提供满意的服务！ 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign3" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="hide msgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								你好，你购买的商品
								<input type="text" class="msg-input" id="goodsTime" value="今天" onkeyup="inputWidth(this)" />
								到
								<input type="text" class="msg-input" value="${siteArea }" id="pjArea" onkeyup="inputWidth(this)" />
								,联系你电话无人接听，看到短信后请联系
								<input type="text" class="msg-input" value="${siteMobile }" id="pjMobile" onkeyup="inputWidth(this)" />
								。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign20" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="hide msgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							<span class="lb w-70 text-c">发送内容：</span>
							<div class="bk-gray pd-10">
								<input type="text" class="msg-input" value="${order.customerName }" onkeyup="inputWidth(this)" />
								您好， 您的预约时间已改至
								<input type="text" class="msg-input" id="proTime" value="${proTime } " onkeyup="inputWidth(this)" />
								，
								...
								。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign4" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="hide msgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10">
								...
								<input type="text" class="msg-input" value="${jdPhone }" onkeyup="inputWidth(this)" />
								。 【
								<input type="text" class="msg-input" value="${serviceName }" id="sign5" onkeyup="inputWidth(this)" />
								服务】
							</div>
					...
					<div class="pr-80 pos-r">
						<div class="bk-gray">
							...
							<div class="h-26">
								<p class="f-r">
									【
									<input type="text" class="msg-input" value="${serviceName }" id="sign6" onkeyup="inputWidth(this)" />
									服务】
								</p>
							</div>
						</div>
					...
					<div class=" defmsgmould">
						<div class="pos-r pl-70 pr-80 mt-10">
							...
							<div class="bk-gray pd-10 defmsgcontent">
								...
								<div class="bk-gray pd-10">
									尊敬的
									<input type="text" class="msg-input" id="custNameTS" value="${order.customerName }" onkeyup="inputWidth(this)" />
									您好， 您的
									<input type="text" class="msg-input" id="ywTS" value="${order.serviceType }" onkeyup="inputWidth(this)" />
									业务，我司已受理， 指派
									<input type="text" class="msg-input" id="emNameMobileTS" value="${msg1 }" onkeyup="inputWidth(this)" />
									为您服务，
									<input type="text" class="msg-input" id="mode1TS" value="注意用电安全请点击${oneHref}">
									，详情咨询上门工程师。 【
									<input type="text" class="msg-input" value="${serviceName }" id="sign10TS" onkeyup="inputWidth(this)" />
									服务】
								</div>
							</div>
					...
					<div class="pr-80 pos-r">
						<div class="bk-gray">
							...
							<div class="h-26">
								<p class="f-r">
									【
									<input type="text" maxlength="8" class="msg-input" value="${serviceName }" id="signdef" onkeyup="inputWidth(this)" />
									服务】
								</p>
							</div>
						</div>
	...
	<!-- 短信催单 -->
	<div class="popupBox msgText msgText2" style="height: 254px;">
		<h2 class="popupHead">
			发送短信
			<a href="javascript:;" class="sficon closePopup"></a>
		</h2>
		<div class="popupContainer" style="height: 212px; overflow: visible;">
				...
				<div class="tabCon">
					<div class="pos-r pl-70 pr-80">
						...
						<div class="bk-gray pd-10">
							...
							催单！ 地址：
							<input type="text" class="msg-input" value="${fns:ej(order.customerAddress)}" onkeyup="inputWidth(this)" />
							【${serviceName }】
						</div>
						<input type="button" onclick="sendMsgDXCD('1')" class="sfbtn sfbtn-green w-70 btn-sendmsg btmark " value="发送" />
					</div>
				</div>
				<div class="tabCon">
					<div class="pr-80 pos-r">
						<div class="bk-gray">
							...
							<div class="h-26">
								<p class="f-r">
									【
									<input type="text" id="dxcdSn" value="${serviceName }" style="text-align: center; width: 120px;" class="msg-input" />
									】
								</p>
							</div>
						</div>
...
$(function(){
	$("#xggd").click(function(){
		...
		if($(this).val()!="保存"){
            ...
            var str='origin,promiseTime,promiseLimit,customerFeedback,remarks,applianceModel,applianceNum,applianceBarcode,applianceMachineCode,buyDate,pleaseReferMall,warrantyType,level,customerType';
...
function cancelFendan(){
	...
	$(function(){
		...
		createUploader("#repairImgsPicker-add","#Imgprocess3","4","","bdImgs");
		$('#Imgprocess3').imgShow();
	}); 
		...
		$.ajax({
			...
			success:function(result){
				if(parseInt(result) > 0){
                    ...
                    $("#arroundCustomerAddress").val('${fns:ej(order.customerAddress)}');
...
function address() {
	...
	if(flag&&checkNum(num)&&code!=null&&code!=""){
		$.ajax({
			...
			customerAddress:"${fns:ej(order.customerAddress)}",warrantyType:"${order.warrantyType}",applianceCategory:"${order.applianceCategory}",applianceBrand:"${order.applianceBrand}"},
			dataType:'text',
			async:false,
			success:function(result){
				layer.msg("操作成功!");
	...
	function resetData(){
		if(isBlank('${serviceName}')){
			$(".btmark").attr("disabled",true);
			$(".btmark").removeClass("sfbtn-green").addClass("sfbtn-gray");
		}
	}
	// 下拉框切换模板
...
function defsendMsgConfirm(){
	...
	//	var empMobiles = "${empMobile}".split(",");
		...
		if(type=='1'){//固定模板
            ...
            + contentRecord.substring(path_3 + 1);
