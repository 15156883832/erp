...
<div class="popupBox odWrap orderdetailVb">
 ...
 --%>							<select id="serviceMode"  disabled="disabled" name="serviceMode" class="select w-120 readonly">
							...
							<span class="select-box w-90 mustfill f-l mr-10" id="showArea" style="display:none">
							<select class="dist select" id="area" disabled="disabled"></select>
							</span>--%>
                                    <input type="text" class="input-text w-580 f-l readonly" readonly="readonly" id="customerAddress1" name="customerAddress1" value="${order.customerAddress }" autocomplete="off"/>
 ...
 --%>						</div>
                            ...
                            <div class="cl mt-10">
                                <div class="f-l pos-r pl-100">
                                    ...
                                    <input type="text" onfocus="WdatePicker({startDate:'1970-01-01'})" class="input-text w-160 readonly ptime" readonly="readonly" id="applianceBuyTime" name="applianceBuyTime" value="<fmt:formatDate value='${order.applianceBuyTime }' pattern='yyyy-MM-dd'/>"/>
                                </div>
                                <div class="f-l pos-r pl-100">
                            ...
                            <div class="mt-10 cl mb-10">
                                ...
                                <%-- <div class="f-l pos-r pl-70">
							<label class="f-l w-70">登记人：</label>
							<input type="text" class="input-text w-100 readonly dischange"  readonly="readonly" name="messengerName" value="${order.xm}"/>
						</div> --%>
                            </div>
                    ...
                    <div class="tabCon">
                        <div style="width: 920px;overflow: auto;">
                            <table class="table table-border table-bordered table-bg table-relatedorder">
								...
								<td>×1</td>
								<td>KFR-120W/S-590KFR-120W/S-590 </td>
								<td>3</td>
								<td>否</td>
								<td>待审核</td>
                        ...
                        <div class="cl mt-10 pos-r txtwrap1" id="oldfittingimg">
                            <!-- <label class="lb lb1">旧件图片：</label>
						<div class="f-l mr-10">
							<div class="imgWrap w-120 text-c">
								<img src="static/h-ui.admin/images/img1.png"></img>
								<p class="lh-20">2017-08-23 10:23:54 </p>
							</div>
						</div> -->
            ...
            <%--  <c:if test="${not empty feedBackDetail}">
                ...
                <%--&lt;%&ndash;<input class="sfbtn sfbtn-opt sbtn" value="${not empty feedBackDetail ? '重新反馈封单' : '反馈封单'}" type="button" id="btn-fbOrder" />&ndash;%&gt;--%>
            ...
            <div class="tabCon">
                <div class="pos-r pl-70 pr-80 mt-10">
                    ...
                    <div class="bk-gray pd-10">
                        <input type="text" class="msg-input" id="custName" value="${order.customerName }" onkeyup="inputWidth(this)" />你好，
                        ...
                        【<input type="text" class="msg-input" value="${serviceName }" id="serviceName1" onkeyup="inputWidth(this)"/>服务】
                    </div>
                    <div id="onlyOne">
            ...
            <div class="tabCon">
                ...
                <div class="pr-80 pos-r">
                    <div class="bk-gray" >
                        ...
                        <div class="h-26">
                            <p class="f-r">【<input type="text" class="msg-input" value="${serviceName }" id="serviceName2" value="捷成家电" onkeyup="inputWidth(this)"/>服务】</p>
                        </div>
                    </div>
        ...
        <div class="popupMain pt-20 pb-20 pl-10 ">
            <div class="cl mb-15">
                <div class="f-l gdxqbox" >
                    <p class="text-c mb-10"><span class="title title1">当前工单</span></p>
                    <ul class="gdxqlist" id="gdxqlist1">
                        <li>
                            <span class="lb">工单编号：</span>
                            <p class="txt text-overflow">
                                ${order.number }
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p class="text-overflow txt">
                                ${order.applianceBrand }${order.applianceCategory }
                            </p>
                        </li>
                        <li>
                ...
                <div class="f-l gdxqbox2">
                    ...
                    <ul class="gdxqlist" id="gdxqlist2">
                        <li>
                            <span class="lb">工单编号：</span>
                            <p class="txt text-overflow" id="xsnumber">

                            </p>
                        </li>
                        <li>
                            <span class="lb">接入时间：</span>
                            <p class="text-overflow txt" id="xscreateTime">

                            </p>
                        </li>
                        <li>
                            <span class="lb">服务工程师：</span>
                            <p class="text-overflow txt" id="xsemployeName">
                            </p>
                        </li>
                        <li>
                            <span class="lb">用户姓名：</span>
                            <p class="text-overflow txt" id="xscustomerName">
                            </p>
                        </li>
                        <li>
                            <span class="lb">联系电话：</span>
                            <p class="text-overflow txt" id="xscustomerMobile">
                            </p>
                        </li>
                        <li>
                            <span class="lb">家电信息：</span>
                            <p class="text-overflow txt" id="xsapplianceBrand">
                            </p>
                        </li>
                        <li>
                            <span class="lb">服务类型：</span>
                            <p class="text-overflow txt" id="xserviceType">
                            </p>
                        </li>
                        <li>
                            <span class="lb">用户地址：</span>
                            <p class="text-overflow txt" id="xscustomerAddress">
                            </p>
                        </li>
                    </ul>
                </div>
...
<script type="text/javascript">
    ...
    if(isBlank(addr)){
        ...
        $(".closePopup").bind('click', function() {
            ...
            //setTimeout(function(){$('#Hui-article-box',window.top.document).css({'z-index':'9'});},1000);
    ...
    function showjiesuanForm() {
        $.ajax({
            url: "${ctx}/order/settlement/canSettlement2017",
            type: 'post',
            data: {
                orderId: '${order.id}'
            },
            success: function (data) {
                if ("T" === data) {
                    openedJiesuanFormIndex = layer.open({
                        type: 2,
                        content: '${ctx}/order/settlement/new2017?id=${order.id}',
                        title: false,
                        area: ['100%', '100%'],
                        closeBtn: 0,
                        shade: 0,
    ...
    $(function(){
        ...
        $("#xggd").click(function(){
            ...
            if($(this).val()!="保存"){
                ...
                var str='origin,promiseTime,promiseLimit,customerFeedback,remarks,applianceModel,applianceNum,applianceBarcode,applianceMachineCode,applianceBuyTime,pleaseReferMall,warrantyType,level';
...
//					$.closeDiv($(".orderdetailVb"));
                ...
                if(result.list.length>0){
                    $.each(result.list,function(index,val){
                        str+="<tr>"+
                            ...
                            "<td class='w-150'>" + val.columns.audit_marks + "</td>" ;
                        if(val.columns.status=="0"){
    ...
    function orderMobile(){
        ...
        $.ajax({
            type:"post",
            url:"${ctx}/order/getOrder2017Mobile",
            data:{
                id :id
            },
            dataType:"json",
            success:function(data){
                ...
                if(obj != "" && obj !=undefined){
                    ...
                    $("#xscustomerAddress").html(obj.columns.customer_address);
