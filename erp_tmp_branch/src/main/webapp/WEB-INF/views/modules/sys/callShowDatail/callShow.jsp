			...
			<div class="popupMain pd-20" id="msgWrap2">
				...
				<div class="tabCon">
					<div class="pos-r pl-70 pr-80">
						...
						<input onclick="sendMsgDXCD('1')" class="sfbtn sfbtn-green w-70 btn-sendmsg btmark  " value="发送" />【${serviceName }】
					</div>
				</div>
				<div class="tabCon">
					<div class="pr-80 pos-r">
						<div class="bk-gray">
							...
							<div class="h-26">
								<p class="f-r">
									【<input type="text" id="signs" maxlength="8" value="${serviceName }" style="text-align:center;width:120px;" class="msg-input" />】
								</p>
							</div>
						</div>
