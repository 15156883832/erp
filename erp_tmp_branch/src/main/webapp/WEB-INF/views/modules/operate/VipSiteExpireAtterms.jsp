        ...
        <div class="page-orderWait">
            <div id="tab-system" class="HuiTab">
                <div class="tabBar cl mb-10">
                    ...
                    <a class="btn-tabBar current" href="${ctx}/operate/VipSiteExpire/Atterms">到期未续费</a>
                    <p class="f-r btnWrap">
...
<script type="text/javascript">
    ...
    function initSfGrid(){
        ...
        var url = "${ctx}/operate/VipSiteExpire/VipAttermsList";
    ...
    function exports(){
        ...
        if(idArr>10000){
            $('body').popup({
                ...
                content:content,
                fnConfirm :function(){
                    location.href="${ctx}/operate/VipSiteExpire/export?formPath=/a/operate/VipSiteExpire/Atterms&&maps="+$("#searchForm").serialize();
                }
