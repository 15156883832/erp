        ...
        <div class="page-orderWait">
            <div id="tab-system" class="HuiTab">
                <div class="tabBar cl mb-10">
                    <a class="btn-tabBar " href="${ctx }/operate/VipSiteExpire/ForOneMon">一个月内</a>
                    <a class="btn-tabBar current" href="${ctx}/operate/VipSiteExpire/ForThreeMon">二到三个月内</a>
...
<script type="text/javascript">
    ...
    function initSfGrid(){
        var url = "${ctx}/operate/VipSiteExpire/VipThreeMonList";
    ...
    function exports(){
        ...
        if(idArr>10000){
            $('body').popup({
                ...
                content:content,
                fnConfirm :function(){
                    location.href="${ctx}/operate/VipSiteExpire/export?formPath=/a/operate/VipSiteExpire/ForThreeMon&&maps="+$("#searchForm").serialize();
                }
