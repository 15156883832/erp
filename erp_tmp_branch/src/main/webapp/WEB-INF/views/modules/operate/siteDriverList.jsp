...
<body>
	...
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl mb-10">
			<sfTags:pagePermission authFlag="NEWSITESETTLE_NEWFAPIAOAPPLYSET_TEEDEFINEDSET_TAB" html='<a class="btn-tabBar  " href="${ctx}/operate/siteVehicle">车辆信息设置</a>'></sfTags:pagePermission>
			<sfTags:pagePermission authFlag="NEWSITESETTLE_NEWFAPIAOAPPLYSET_TEEDEFINEDSET_TAB" html='<a class="btn-tabBar  current" href="${ctx}/operate/siteDriver">司机信息设置</a>'></sfTags:pagePermission>
		<p class="f-r btnWrap">
			...
			<form id="searchForm">
				...
				<div class="bk-gray pt-10 pb-5">
					<table class="table table-search">
						<tr>
							<th style="width: 76px;" class="text-r">司机姓名：</th>
							<td>
								<input type="text" class="input-text" name="driverName" id="driverName"/>
							</td>
							<th  style="width: 76px;" class="text-r">联系电话：</th>
							<td colspan="6">
								<input type="text" class="input-text"  name="driverMobile" id="driverMobile"/>
							</td>
...
$('#btn-add').click(function(){
	layer.open({
		...
		type : 2,
		content:'	${ctx}/operate/siteDriver/form',
		title:false,
		area: ['100%','100%'],
		closeBtn:0,
		shade:0,
...
function initSfGrid(){
	sfGrid = $("#table-waitdispatch").sfGrid({
		url : '${ctx}/operate/siteDriver/siteDriverList', 
		...
		var content = "确认要删除这司机信息？";
			$('body').popup({
				...
				fnConfirm : function() {
					...
					$.ajax({
						type : "POST",
						url : "${ctx}/operate/siteDriver/deletesiteDriver",
						traditional : true,
						data : {
							"id" : id
						},
