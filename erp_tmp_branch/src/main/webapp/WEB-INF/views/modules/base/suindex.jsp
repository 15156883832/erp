	...
	<header class="navbar-wrapper navbarHeader">
		<div class="navbar navbar-sflogo">
			...
			<nav class="breadcrumb f-l c-222">
				...
				<span>当前位置：</span>
				<a href="javascript:;" class=""><span id="module_span">系统设置</span></a>
				<a href="javascript:;" class=""><span class="en">&gt;</span><span id="sub_module_span">菜单设置</span></a>
			</nav>
...
<section class="Hui-article-box" id="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span data-href="${ctx}/sys/menu">菜单设置</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${ctx}/sys/menu" allowtransparency="yes"></iframe>
		</div>
	</div>
</section>
