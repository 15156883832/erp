	...
	<header class="navbar-wrapper navbarHeader">
		<div class="navbar navbar-sflogo">
			...
			<nav class="breadcrumb f-l c-222">
				...
				<span>当前位置：</span>
				<a href="javascript:;" class=""><span id="module_span">产品管理</span></a>
				<a href="javascript:;" class=""><span class="en">&gt;</span><span id="sub_module_span">平台产品</span></a>
			</nav>
...
<aside class="Hui-aside hide1" id="Hui-aside">
	<div class="menu_dropdown bk_2">
		<c:set var="hasWelcome" value="0"></c:set>
				...
				<dd>
					<ul>
						<c:forEach items="${menu.children}" var="child" varStatus="idx">
							<c:if test="${child.name eq '平台产品'}">
								<c:set var="hasWelcome" value="1"></c:set>
							</c:if>
...
<section class="Hui-article-box" id="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<c:if test="${hasWelcome == '0' }">
						<span data-href="##"></span><em></em>
					</c:if>
					<c:if test="${hasWelcome eq '1' }">
						<span data-href="${ctx}/goods/platform/WholePlatHeader">平台产品</span><em></em>
					</c:if>
				</li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<c:if test="${hasWelcome == '0' }">
				<iframe scrolling="yes" frameborder="0" src="javascript:void();" allowtransparency="yes"></iframe>
			</c:if>
			<c:if test="${hasWelcome eq '1' }">
				<iframe scrolling="yes" frameborder="0" src="${ctx}/goods/platform/WholePlatHeader" allowtransparency="yes"></iframe>
			</c:if>
		</div>
	</div>
</section>
