    ...
    <div class="popupContainer pos-r">
        <form id="addbalanceform">
            ...
            <div class="popupMain pt-15 pb-15 pr-20" >
                <div class="cl mb-10">
                    <label class="w-110 text-r f-l"><em class="mark">*</em>费用科目：</label>
                    <span class="w-170 f-l dropdown-sin-2 addspan">
                         <%--<select class="select-box w-120 "  id="exacctName"  placeholder="请选择"  multiline="true" name="exacctName" datatype="*" nullmsg="请选择费用科目"   >--%>
                             <select     class="select w-170 " style="position: absolute;z-index: 1;" class="choose" onmousedown="if(this.options.length>6){this.size=8}" onblur="this.size=0" onchange="this.size=0" name="exacctName"  id="exacctName" datatype="*" nullmsg="请选择费用科目">
                ...
                <div class="cl mb-10">
                    <label class="w-110 text-r f-l"><em class="mark">*</em>费用总额：</label>
                ...
                <div class="cl mb-10">
                    <label class="w-110 text-r f-l">详细内容：</label>
                    <textarea class="textarea h-50 f-l" style="width: 440px;" name="detail_content" id="detail_content" >${bm.columns.detail_content}</textarea>
                </div>

                <div class="cl mb-10">
                    <label class="w-110 text-r f-l"><em class="mark">*</em>费用发生人：</label>
                    <span class="w-170 f-l dropdown-sin-2 addspan2">
                        ...
                        <select     class="select w-170 " style="position: absolute;z-index: 1;" class="choose" onmousedown="if(this.options.length>6){this.size=8}" onblur="this.size=0" onchange="this.size=0" name="createName"  id="createName" datatype="*" nullmsg="请选择费用发生人！">
                 ...
                 <div class="cl mb-10">
                    <label class="w-110 text-r f-l">品牌：</label>
                    <div class="priceWrap w-170 f-l">
                ...
                <div class="cl mb-10">
                    ...
                    <c:if test="${imagesSize < 5 && not empty images}">
                        <div class="f-l mr-10">
                            <div class="imgWrap jiahao" id="jiahao" >
                                <div id="filePicker-add">
                                    <a href="javascript:;" class="btn-upload"></a>
                    ...
                    <input type="hidden" name="img" value="${fitting.img}" id="imgs">
                </div>
...
<script>
    var feedImgsCount = '${imagesSize}';

    $(function () {
        $('#exacctName').select2();
        $("#exacctName").next(".select2").find(".selection").css("width","170px");
        $('#createName').select2();
        $("#createName").next(".select2").find(".selection").css("width","170px");
        $('.ticketAdd').popup();
