...
<script type="text/javascript" src="${ctxPlugin}/lib/select/select2.full.min.js"></script> 
  ...
  <body>
	...
	<div id="tab-system" class="HuiTab">
		...
		<sfTags:pagePermission authFlag="FINANCEMGM_SITEREVENUEDETAIL_ORDERREVENUEDETAIL_TAB" html='<a class="btn-tabBar current" href="${ctx}/finance/revenue/toEmployeGoodsDetail">销售提成明细</a>'></sfTags:pagePermission>
			<p class="f-r btnWrap">
...
function initSfGrid(){
	var url = "${ctx}/finance/revenue/toEmployeGoodsAllGrid";
	...
	function yfMny(row) {
		var yfje = row.ticheng - row.commissions ;
		return yfje.toFixed(2);
	}
