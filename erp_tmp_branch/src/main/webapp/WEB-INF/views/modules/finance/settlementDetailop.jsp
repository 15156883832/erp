                ...
                <div class="retractWrap">
					...
					<div class="cl mb-10">
						...
						<div class="priceWrap w-100 f-l readonly">
							<input type="text" class="input-text readonly" readonly="readonly" value="${st.orderSettlement.profits}" id="profit"/>
							<span class="unit">元</span>
						</div>
						<label class="w-100 text-r f-l lh-26" style="margin-left: 320px"> <span class="c-005aab va-t">当日支付</span>：</label>
						<div class="priceWrap w-100 f-l readonly">
							<input type="text" class="input-text readonly" value="${dailyPay }" id="payed-mirror" readonly="readonly"/>
							<span class="unit">元</span>
						</div>
					</div>
