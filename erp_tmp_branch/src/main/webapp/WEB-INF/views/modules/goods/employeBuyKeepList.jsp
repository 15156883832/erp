...
<div class="sfpagebg bk-gray" style="overflow: hidden">
	<div class="page-orderWait goodsPage">
		<div class="tabBar cl mb-10">
			<sfTags:pagePermission authFlag="GOODSMGM_EMPLOYEBUY_EMPLOYEBUYSTOCKS_TAB" html='	<a class="btn-tabBar  " href="${ctx}/goods/siteself/BuyEmployeSite">工程师自购库存</a>'></sfTags:pagePermission>
				<sfTags:pagePermission authFlag="GOODSMGM_EMPLOYEBUY_EMPLOYEBUYSRECORD_TAB" html='<a class="btn-tabBar current" href="${ctx}/goods/siteGoodsKeep/buyEmpList">自购库存明细</a> '></sfTags:pagePermission>
		...
		<form action="${ctx}/goods/siteGoodsKeep/buyEmpList" id="searchForm" method="post">
				...
				<tr>
					...
					<td>
						<select class="select" name="mxtype" style="width: 140px;">
							...
							<option value="4" ${map.mxtype eq '4'?'selected':''}>自购</option>
		...
		<div class="pt-10 pb-5 cl btnsWrap">
			<div class="f-r">
				...
				<sfTags:pagePermission authFlag="GOODSMGM_EMPLOYEBUY_EMPLOYEBUYSRECORD_EXPORTS_BTN" html='<a href="javascript:exports();" class="sfbtn sfbtn-opt2"><i class="sficon sficon-export"></i>导出</a>'></sfTags:pagePermission>
			</div>
		</div>
		...
		<div class="mb-10" id="goodsTableWrap">
			<table class="table table-bg text-c goodsTable" style="table-layout: auto">
				...
				<tr class="bb">
					...
					<td class="w-120" >${orderDetails.columns.orderNumber} </td>
					<td class="w-100">
						<p><fmt:formatDate value="${orderDetails.columns.create_time}" pattern="yyyy-MM-dd"/></p>
...
<script type="text/javascript">
    $(function(){
        ...
        tableHeight();
        var pageSize=${page.pageSize};ekeep
    ...
    function exports(){
        ...
        if(idArr>10000){
            $('body').popup({
                ...
                content:content,
                fnConfirm :function(){
                    location.href="${ctx}/goods/siteGoodsKeep/exportEmpZg?formPath=/a/goods/siteGoodsKeep/empListZg&&maps="+$("#searchForm").serialize();
                }
            });
        }else{
            location.href="${ctx}/goods/siteGoodsKeep/exportEmpZg?formPath=/a/goods/siteGoodsKeep/empListZg&&maps="+$("#searchForm").serialize();
