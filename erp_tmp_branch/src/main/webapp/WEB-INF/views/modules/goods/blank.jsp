...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="static/h-ui.admin/css/sfskin_cyan.css" />-->
    ...
    <![endif]-->
    <title>待派工工单-全部</title>
</head>
<body class="">
<div class="sfpagebg bk-gray"><div class="sfpage">
    <div class="page-orderWait">
        <div class="nodateBox noYj " >
            <h3 class="">您所在的${site.city}暂无待售样机，请您持续关注！</h3>
        </div>
...
<script src="${ctxPlugin}/static/h-ui.admin/js/jquery.jqGrid.src.js" type="text/javascript" charset="utf-8"></script>
...
<script src="${ctxPlugin}/static/h-ui.admin/js/jquery.rotate.min.js" type="text/javascript" charset="utf-8"></script>
<script src="${ctxPlugin}/static/h-ui.admin/js/imgShow.js" type="text/javascript" charset="utf-8"></script>
