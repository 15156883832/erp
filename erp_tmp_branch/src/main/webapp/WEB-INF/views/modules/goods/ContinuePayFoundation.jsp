		...
		<div class="popupMain pt-15">
			<div class="pcontent">
				...
				<div class="llbox bk-gray">
					...
					<span class="f-r mr-10">单号：${orderDetail.logisticsNo}</span>
					<span class="f-r mr-10">名称：${orderDetail.logisticsName}</span>
					</h3>
					...
					<ul class="logisticslist pt-5 pb-5" style="min-height: 200px;max-height: 400px;overflow: auto">
						<c:forEach items="${list }" var="log" varStatus="idx">
...
<script type="text/javascript">
	...
	function conmitOrder(){
		...
		if(isBlank(num)){
			...
			$.ajax({
				type : "POST",
				url : "${ctx}/goods/mjl/repeatConmit",
				data : {
					"id" : id,
					num:num,
				...
				success : function(data) {
					layer.msg("提交成功！");
					window.location.href='${ctx}/goods/mjl/list';
					$('#Hui-article-box',window.top.document).css({'z-index':'9'});
				}
			});
		}
