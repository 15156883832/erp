            ...
            <form id="orderForm" >
                        <div class="mb-25">
                                        ...
                                        <div class="wrap1 w-140" style="margin: 0 auto;">
                                            <div class="countWrap w-140 mb-5">
                                                ...
                                                <div class="priceWrap readonly">
                                                    <input type="text" id="adj_num10" readonly name="quantity10" class="input-text text-c readonly" value="10"/>
                                            ...
                                            <p class=" text-l">
                                                <label class="mt-10 sficon1 sficon-rad1 sficon-rad1_selected cPointer" data-unit="个" data-num="10">按个</label>
                            ...
                            <div class="cl mb-10 hide">
                                ...
                                <input type="hidden" name="pid10A" value="${platform.columns.good_sign eq 'CW08040801' ? platform.columns.id:'' }"/>
                ...
                <div class="cl">
                    <div class="f-r">
                        <span class="mr-10 hide" id="openVIP"><a class="c-fd6e32 underline va-t sficon1 sficon-crown1 mr-5 f-14" onclick="jumpToVIP()">开通会员</a><span class="f-13">立减<span class="CW08040801 va-t"></span></span></span>
                        <span class="mr-10" id="hadYouHui">已优惠：<span class="">￥<span class="CW08040801" ></span></span></span>
...
<script type="text/javascript">
    ...
    function checkout() {
        ...
        $.ajax({
            url: "${ctx}/goods/sitePlatformGoods/createflavorBoxOrder",
            type: "POST",
    ...
    function checkPrice(){
        $.post("${ctx}/goods/nanDao/checkPriceForFlavorBox",$("#orderForm").serialize(),function(result){
            if(result=='fal'){
    ...
    var newId="";
    function addGoods(){
        $.post("${ctx}/goods/nanDao/getAllDetergent",{id:goodIds},function(result){
            if(result!=null){
                var html='';
                for(var i=0;i<result.length;i++){
                    ...
                    }else if(newGoodSign=='QJ18040202'){
    ...
    function countAnythingPrice(){
        ...
        if(sitePrice10A != '0'){//只有10A的
            ...
            $(".CW08040801").text(youhui.toFixed(2));
    ...
    function getLogisticsPrice(num,province){
        ...
        if($.trim(province) != "香港" && $.trim(province) != "澳门" && $.trim(province) != "台湾"){
            $.ajax({
                url: "${ctx}/goods/sitePlatformGoods/checkLogisticsForFlavorBox",
                type: "POST",
                data: {
                    province:province,
                    num:num,
