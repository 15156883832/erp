		...
		<div class="pcontent pt-10">
			<div class="cl w-710">
				...
				<div class="f-l mb-10">
					...
					<label class="f-l w-100"> 工程师库存数量：</label>
					<input type="text" class="input-text w-140 f-l readonly" readonly="readonly" name="gstocks" id="gstocks" value="${siteSelf.columns.empStocks }"/>	
				</div>
			    <div class="f-l mb-10">
				...
				<div class="f-l mb-10">
					...
					<input type="text" class="input-text w-140 f-l readonly" readonly="readonly" name="sortNum" value="${siteSelf.columns.empName }"/>
				</div>
			</div>
