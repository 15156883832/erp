        ...
        <div class="goodsDetail">
            <div class="cl mb-20">
                ...
                <div class="f-l">
                    ...
                    <a class="btn_buyGoods radius" onclick="showBuy('${platform.columns.id}')">立即购买</a>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function showBuy(id){
        ...
        show_navLi.each(function () {
            ...
            if ($(this).find('span').text() == '南岛漏保') {
                bStopIndex = show_navLi.index($(this));
                bStop = true;
            }
        });
        if (!bStop) {
            creatIframe('${ctx}/goods/sitePlatformGoods/showBuySouthUpgrade?id='+id, '南岛漏保');
        } else {
            show_navLi.eq(bStopIndex).addClass('active');
            $('#iframe_box .show_iframe',window.top.document).hide().eq(bStopIndex).show().find('iframe').attr({'src': '${ctx}/goods/sitePlatformGoods/showBuySouthUpgrade?id='+id,});
