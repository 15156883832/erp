...
<div class="page-orderWait">
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl mb-10">
			<a class="btn-tabBar" href="${ctx}/order/viewManager">弹屏设备</a>
			<a class="btn-tabBar current"  href="${ctx }/goods/platFormOrder/bombScreenHeaderList">弹屏订单</a>
			<p class="f-r btnWrap">
...
function initSfGrid(){
	$("#table-waitdispatch").sfGrid({
		url : '${ctx}/goods/platFormOrder/bombScreenGrid',
...
function exports(){
	...
	if(idArr>10000){
		$('body').popup({
			...
			content:content,
			 fnConfirm :function(){
				 location.href="${ctx}/goods/platFormOrder/export3?formPath=/a/goods/platFormOrder/bombScreenHeaderList&&maps="+$("#searchForm").serialize(); 
			 }
		});
	}else{
		 location.href="${ctx}/goods/platFormOrder/export3?formPath=/a/goods/platFormOrder/bombScreenHeaderList&&maps="+$("#searchForm").serialize();
