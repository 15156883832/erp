	...
	<div class="popupContainer">
		<div class="popupMain">
			...
			<div class="cl mb-10">
				...
				<input type="hidden" name="name" value="${platform.columns.name }"/>
			...
			<div class="mb-10 cl f-13">
				...
				<p class="f-l lh-24 f-13">电子名片</p>
			</div>
			<div class="cl mb-15">
				<label class="w-100 f-l"><em class="mark">*</em>购买数量：</label>
				<div class="countWrap  w-140 f-l">
					<a href="javascript:subNum();" class="btn-minus"></a>
					<span class="priceWrap w-80">
						<input type="text" id="adj_num" name="quantity" class="input-text " value="1" />
						<span class="unit">包</span>
					</span>
					<a href="javascript:addNum();" class="btn-plus"></a>
				</div>
				<label class="w-100 f-l">规格：</label>
				<div class=" w-200 f-l " style="line-height: 27px">
					每包70张，每张54个二维码。
				</div>
			</div>
			<div class="cl mb-15">
...
function checkout() {
	...
	$.ajax({
		url: "${ctx}/goods/sitePlatformGoods/createCodeOrder",
		type: "POST",
