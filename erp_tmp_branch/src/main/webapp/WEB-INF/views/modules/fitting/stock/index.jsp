	...
	<div class="page-orderWait">
		<div id="tab-system" class="HuiTab">
			<div class="tabBar cl mb-10">
				<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_TAB" html='<a class="btn-tabBar current"  href="${ctx }/fitting/stock/index">公司库存</a>'></sfTags:pagePermission>
			...
			<div class="tabCon">
					...
					<div class="bk-gray pt-10 pb-5">
						<table class="table table-search">
							<tr>
								...
								<th style="width: 76px;" class="text-r">库存类别：</th>
								<td>
							...
							<tr>
								...
								<td>
								<span class="select-box">
									<select class="select" name="supplier" style="width: 140px;">
										<option value="">请选择</option>
								...
								<th style="width: 76px;" class="text-r">库位：</th>
								<td>
									<input type="text" class="input-text" name = "location"/>
								</td>
								<th style="width: 76px;" class="text-r">库存量：</th>
								<td colspan="3">
									<input type="text" class="input-text numberTest" name = "minWarning" style="width: 100px;"/>
									~
									<input type="text" class="input-text numberTest" name = "maxWarning" style="width: 100px;"/>
								</td>
				...
				<div class="pt-10 pb-5 cl">
					<div class="f-l">
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_ADD_BTN" html='<a href="javascript:modify();" class="sfbtn sfbtn-opt" id="xzhelp"><i class="sficon sficon-add"></i>新增</a>'></sfTags:pagePermission>
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_SELL_BTN" html='<a href="javascript:bjls();" class="sfbtn sfbtn-opt"><i class="sficon sficon-ls"></i>零售</a>'></sfTags:pagePermission>
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_SDINPUT_BTN" html='<a href="javascript:sdruku();" class="sfbtn sfbtn-opt" id="rkhelp"><i class="sficon sficon-sdrk"></i>手动入库</a>'></sfTags:pagePermission>
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_SDINPUT_NEWRETURN" html='<a href="javascript:showTurnBackDispatcher();" class="sfbtn sfbtn-opt"><i class="sficon sficon-fc"></i>新件返厂</a>'></sfTags:pagePermission>
						 <a href="javascript:prinTurnBack();" class="sfbtn sfbtn-opt"><i class="sficon sficon-print" ></i>批量打印</a>
						<sfTags:pagePermission authFlag="FITTINGMGM_FITAPPLY_ALLAPPLY_ENGINEERAPPLY_BTN" html='<a href="javascript:addEmployFittingApply();" class="sfbtn sfbtn-opt" id="btn-gcssq"><i class="sficon sficon-gcsapplication"></i>工程师备件领取登记</a>'></sfTags:pagePermission>
					</div>
					<div class="f-r">
						<a href="javascript:;" class="sfbtn sfbtn-opt2 reloadPageBtn"><i class="sficon sficon-reload"></i>刷新</a>
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_PLIMPORT_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2" id="btnImport"><i class="sficon sficon-import"></i>批量导入</a>'></sfTags:pagePermission>
						...
						<sfTags:pagePermission authFlag="FITTINGMGM_FITSTOCK_COMPANYSTOCK_PLDELETE_BTN" html='<a href="javascript:plsc();" class="sfbtn sfbtn-opt2"><i class="sficon sficon-rubbish"></i>批量删除</a>'></sfTags:pagePermission>
					</div>
		...
		<div class="popupContainer">
			<div class="popupMain">
				<div class="cl mb-10">
					...
					<input type="text" class="input-text w-140 f-l " maxlength="50" name="customerName"/>
					<label class="f-l w-100">联系方式：</label>
					<input type="text" class="input-text w-140 f-l " maxlength="20"  name="customerMobile" />
				</div>
				<div class="cl mb-10">
					<label class="f-l w-80">详细地址：</label>
					<input type="text" class="input-text  f-l " maxlength="255"  style="width:380px;" name="customerAddress"/>
				</div>
				<div class="cl mb-10">
				...
				<div class="cl ">
					...
					<textarea id="outstockMark" name="outstockMark" style="width:380px;height:60px;" class="textarea"></textarea>
				</div>
...
<div class="popupBox bjfcbox w-520">
	<form id="fc_form">
		<h2 class="popupHead">
			新件返厂
			<a href="javascript:;" class="sficon closePopup"></a>
		...
		<div class="popupContainer">
			<div class="popupMain pd-15">
				...
				<div class="cl mb-10">
					<label class="f-l w-80">备件品牌：</label>
				...
				<div class="cl mb-10">
					...
					<input type="text" class="input-text w-140 f-l readonly" readonly="readonly" name="type"/>
				</div>
				<div class="line-dashed mb-10"></div>
				<div class="cl mb-10">
					<label class="f-l w-80">库存数量：</label>
					<input type="text" class="input-text w-140 f-l readonly" readonly="readonly" name="stock" value=""/>
					<label class="f-l w-100"><em class="mark">*</em>返厂数量：</label>
					<input type="text" class="input-text w-140 f-l "  name="backNum"/>
					<%--<input type="hidden" name="stock" value=""/>--%>
				</div>
				<div class="text-c mt-20">
					<a href="javascript:doTurnBack();" class="sfbtn sfbtn-opt3 w-70 mr-5">保存</a>
					<a href="javascript:close('.bjfcbox');" class="sfbtn sfbtn-opt w-70 mr-5">取消</a>
				</div>
			</div>
		</div>
	</form>
	...
	<div class="popupContainer pos-r">
		<div class="popupMain">
			<div class="pcontent">
				...
				<div class="mt-10 ">
					备注：<input type="text" style="width:948px" class="input-text" id="fittingInStockRemarks"/>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        uploader = WebUploader.create({
            ...
            server: '${ctx}/fitting/checkUnfinishedFittingExcel',
            pick: {
                id: '#btn-import',
        ...
        uploader.on('beforeFileQueued', function(file){
            ...
            uploader.option( 'server', '${ctx}/fitting/checkUnfinishedFittingExcel');
        });
        uploader.on( 'uploadSuccess', function( file, response ) {
            if(response.operType == "check"){
                if(response.templateError == "y"){
                    ...
                    uploader.stop();
                    file.setStatus('queued');
                    uploader.option( 'server', '${ctx}/fitting/importFitting');
                    layer.msg("校验成功，可以导入!");
                }else{
                    $("#filename").val('');
                    layer.msg("解析Excel错误!");
    ...
    function initSfGrid(){
        $("#table-waitdispatch").sfGrid({
            url : '${ctx}/fitting/stock/ajaxList',
    ...
    function modify(id){
        xiugai=layer.open({
            type : 2,
            content:'${ctx}/fitting/stock/form?id='+id,
            title:false,
            area: ['100%','100%'],
            closeBtn:0,
            shade:0,
    ...
    function sdruku(){
        ...
        for (var i = 0; i < rowDatas.length; i++) {
            ...
            html += '	<td class="text-c brand-' + i + '"> ' + rowDatas[i].brand + '</td>';
            html += '	<td class="text-c category-' + i + '">' + rowDatas[i].suitCategory + '</td>';
            html += '	<td class="text-c"><input type="text" class="input-text num-' + i + '" name="num"/></td>';
            html += '	<td class="text-c"><input type="text" class="input-text price-' + i + '" name="price" value="' + rowDatas[i].sitePrice + '"/></td>';
    ...
    function doSdrk() {
        ...
        $("tr[name='sdrk_tr']").each(function (index) {
            ...
            if (((index+1)!=si) && num * 1 <= 0) {
                layer.msg("请输入第"+(index+1)+"行的正确的入库数量!");
                $(this).find("input[name='num']").focus();
                check = false;
                return;
            }
        ...
        var remarks=$("#fittingInStockRemarks").val();

        if (!check) {
        } else {
            manuallyStockPosted = true;
            $.post("${ctx}/fitting/stock/dosdruku", {"data": str,"remarks":remarks}, function (result) {
                if(result==="ok"){
                    ...
                    $.ajax({
                        ...
                        success : function(data) {
                            if(data==1){
                                ...
                                layer.msg('备件有申请未完成的记录或工程师有对应库存,不可删除!', {time: 1000});
                            }
                        }
                    });
                }
...
//	}
    ...
    function exports(){
        ...
        if(idArr>10000){
            $('body').popup({
                ...
                content:content,
                fnConfirm :function(){
                    location.href="${ctx}/fitting/stock/export?formPath=/a/fitting/stock/index&&maps="+$("#searchForm").serialize();
                }
    ...
    function addEmployFittingApply(){
        ...
        layer.open({
            type : 2,
            content:'${ctx}/fitting/stock/addEmployeFittingApply?ids='+ids,
            title:false,
            area: ['100%','100%'],
            closeBtn:0,
            shade:0,
    ...
    function showTurnBackDispatcher() {
//        /fitting/stock
        $("input[name='backNum']").val("");
        var ids=$('#table-waitdispatch').jqGrid("getGridParam", "selarrrow");
        if(ids == null || ids.length == 0){
        ...
        $.ajax({
            url:'${ctx}/fitting/stock/fittingFrom',
            data:{fittingId: ids[0]},
            success: function (result) {
                if (result === "1") {
                    // 备件来自厂家
					showTurnBack();
        ...
        for (var i = 0; i < ids.length; i++) {
            ...
            if (isBlank(codes)) {
               codes = rowData.code;
            	...
            	codes =codes +","+ rowData.code;
            }
        }
        if (!isBlank(ids)) {
            layer.open({
                type: 2,
                content: '${ctx}/fitting/stock/toNewReturnFactoryPage?ids=' + ids,
                title: false,
                area: ['100%', '100%'],
                closeBtn: 0,
                shade: 0,
