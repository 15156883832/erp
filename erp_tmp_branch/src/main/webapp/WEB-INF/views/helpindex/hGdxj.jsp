...
<body >
	...
	<h1 class="jpageTitle">新建工单</h1>

	<div class="partContainer">
		<div class="partNote mb-15">
			1、点击【工单管理】-【全部工单】/【待派工工单】页面，点击【新建工单】按钮，打开新建工单弹窗：<br>
			2、输入工单必填项及其他信息后，点击【保存】，新建工单完成。
		</div>
		<img src="${ctxPlugin}/static/h-ui.admin/images/help_v2/05新建工单.png" class="img" />
