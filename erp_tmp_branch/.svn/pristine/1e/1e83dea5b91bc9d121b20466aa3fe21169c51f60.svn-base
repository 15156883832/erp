...
<head>
	...
	<script type="text/javascript">
		...
		function printOrder() {
            var number='${order.columns.number}';
            $.ajax({url:"${ctx}/print/writePrintTimesForOld400", type:"post", data:{number:number}, success:function(result){}});
...
<div class="printpage wrap" style="position:relative;">
	...
	<div class="cl" style="font-size: 1.2em;overflow: hidden">
		...
		<div class="f-r" style="float: right">派工时间：<span style="  display: inline-block;width: 180px;"> <fmt:formatDate value="${order.columns.dispatch_time }" pattern="yyyy-MM-dd hh:mm"/></span></div>
	</div>
