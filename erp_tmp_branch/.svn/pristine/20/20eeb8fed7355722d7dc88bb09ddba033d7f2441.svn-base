	...
	<div class="popupContainer pos-r">
		<div class="popupMain">
			<div class="pcontent" id="originbox" >
				<div class="cl mb-10">
					<label class="f-l w-70"><em class="mark">*</em>商品类别：</label>
...
<script type="text/javascript">
	...
	$("#btnSubmit").click(function(){
      ...
      layer.msg("品类名有重复")
		...
		$.ajax({
			type:'POST',
			url:'${ctx}/order/goodscategory/queryNums',
			traditional: true,
			...
			if(!result.flag){
				$.ajax({
					type:'POST',
					url:"${ctx}/order/goodscategory/save",
					traditional: true,
					data:{
						"nameArr":nameArr,
					    "sortsArr":sortsArr			
					...
					success:function(data){
						...
						$.closeDiv($(".addOrigin"));
				    //window.location.href="${ctx}/order/goodscategory";
					}
				});
			}else{
				layer.msg("名字已被使用!");
