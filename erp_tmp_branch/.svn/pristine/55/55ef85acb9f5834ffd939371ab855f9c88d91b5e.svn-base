			...
			<div class="page-orderWait">
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl mb-10">
						...
						<a class="btn-tabBar current" href="${ctx}/goods/siteself/ewmCollectionHeader">二维码收款分析</a>
						<p class="f-r btnWrap">
	...
	var sortHeader = '${headerData.sortHeader}'; //服务商自定义过的表格头部
	   ...
	   function initSfGrid() {
			sfGrid = $("#table-waitdispatch").sfGrid({
				url : '${ctx}/goods/siteself/ewmCollectionList',
		...
		function zfpz(rowData){
			return html='<span class="proofImg"><a class="c-0383dc">凭证</a> <img src="${commonStaticImgPath}'+rowData.imgs+'" /> </span>'; 
		}
		
		function xxdz(rowData){
			if(rowData.customer_address != null && $.trim(rowData.customer_address) != "" && rowData.customer_address != "(null)"){
				return rowData.customer_address;
			}
			return "";
		}
		...
		function exports(){
			...
			if(idArr>10000){
				$('body').popup({
					...
					content:content,
					 fnConfirm :function(){
						 location.href="${ctx}/goods/siteself/exportEwmAnalyse?formPath=/a/goods/siteself/ewmCollectionHeader&&maps="+$("#searchForm").serialize();
					 }
