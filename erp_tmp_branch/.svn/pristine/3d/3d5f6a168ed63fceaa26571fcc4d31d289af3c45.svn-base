...
<body style="overflow: hidden;background-color:#e6e6e6; background-position:center top;">
    <!-- <div id="mainBody">
	...
	<script src="${ctxStatic}/jquery/jquery-1.6.2.min.js" type="text/javascript"></script>
