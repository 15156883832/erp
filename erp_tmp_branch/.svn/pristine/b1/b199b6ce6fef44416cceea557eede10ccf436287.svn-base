...
//		Db.update("UPDATE crm_goods_siteself_order a SET a.status='3',a.outstock_type='2' WHERE a.id='"+rowId+"'");
		...
		Record rd = Db.findFirst("SELECT a.*,b.good_number FROM crm_goods_siteself_order a left join crm_goods_siteself_order_goods_detail b on a.id=b.site_order_id WHERE a.id='"+rowId+"'");
