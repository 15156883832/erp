				...
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.haixin eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_HAIXINORDER_TAB"
								html='<a id="haixin" class="btn-tabBar "  href="${ctx }/order/ChangeSelfOrder/haixinHeaderList">海信工单</a>'></sfTags:pagePermission>
						</c:if>
						...
						<c:if test="${map.suning eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_TAB"
								html='<a id="suning" class="btn-tabBar current "  href="${ctx }/order/ChangeSelfOrder/suningHeaderList">苏宁工单</a>'></sfTags:pagePermission>
						</c:if>
					...
					<div class="tabCon">
							...
							<div class="bk-gray pt-10 pb-5">
								<table class="table table-search">
									<tr>
										...
										<td>
											<span class="w-140">
												<select class="select easyui-combobox" id="statusFlag" multiple="true" multiline="false" name="status" style="width: 100%; height: 25px" panelMaxHeight="300px">
													<option value="初始">初始</option>
													<option value="派单网点（派工下达）">派单网点（派工下达）</option>
													<option value="派单工人（网点接收）">派单工人（网点接收）</option>
													<option value="网点拒绝">网点拒绝</option>
													<option value="服务完成">服务完成</option>
													<option value="服务取消">服务取消</option>
													<option value="服务确认">服务确认</option>
													<option value="待收款">待收款</option>
													<option value="暂缓服务">暂缓服务</option>
													<option value="作业封单">作业封单</option>
													<option value="申请关闭">申请关闭</option>
												</select>
											</span>
										</td>
									...
									<tr>
										...
										<td>
											<input type="text" class="input-text" style="width: 140px;" name="customerMobile" onkeydown="enterEvent(event)" />
						...
						<div class="ordertjbox mt-10 cl">
							...
							<%--<div class="col-5-1 ordertj-item">
							<div class="bk-gray">
								<div class="ordertxt1">
									<p class="bg bg12"></p>
							...
							<div class="col-5-1 ordertj-item" onclick="warningOrder(4)" style="cursor: pointer;">
								<div class="bk-gray">
									<div class="ordertxt1">
										...
										<p class="txt">
											超20h预警工单（
											<span class="f-18 c-f36a5a va-t" id="20hCount">0</span>
											）
										</p>
									</div>
								</div>
							...
							<div class="col-5-1 ordertj-item" onclick="warningOrder(5)" style="cursor: pointer;">
								<div class="bk-gray">
									<div class="ordertxt1">
										...
										<p class="txt">
											超24h预警工单（
											<span class="f-18 c-f36a5a va-t" id="24hCount">0</span>
											）
										</p>
									</div>
								</div>
						...
						<div class="pt-10 pb-5 cl">
							<div class="f-l">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_ZZJ_BTN"
									html='<a href="javascript:;" class="sfbtn sfbtn-opt" onclick="zzj();"><i class="sficon sficon-zzj"></i>转自接</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_PLDELETE_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_MARKORDER_BTN"
									html='<a href="javascript:showMarkOrders();" class="sfbtn sfbtn-opt"><i class="sficon sficon-sign"></i>标记工单</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_CANCELMARK_BTN"
									html='<a href="javascript:cancelMarkOrders();" class="sfbtn sfbtn-opt"><i class="sficon sficon-signCancel"></i>取消标记</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_PLPRINT_BTN"
							...
							<div class="f-r">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_EXPORT_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_SUNINGORDER_HEADERSET_BTN"
	...
	<script type="text/javascript">
		...
		function initSfGrid() {
			$("#table-waitdispatch").sfGrid({
				url : '${ctx}/order/ChangeSelfOrder/FourSuningOrder',
				sfHeader : defaultHeader,
				sfSortColumns : sortHeader,
				rownumbers : true,
		...
		function reset() {
			...
			html += '<option value="已派至网点">已派至网点</option>';
			html += '<option value="已核销">已核销</option>';
			html += '<option value="已审核">已审核</option>';
			html += '<option value="已回访">已回访</option>';
			html += '</select>  </span>';
		...
		function exports() {
			...
			if (idArr > 10000) {
				$('body').popup({
					...
					content : content,
					fnConfirm : function() {
						location.href = "${ctx}/order/ChangeSelfOrder/exportSuning?formPath=/a/order/ChangeSelfOrder/suningHeaderList&&maps=" + $("#searchForm").serialize();
					}
				});
			} else {
				location.href = "${ctx}/order/ChangeSelfOrder/exportSuning?formPath=/a/order/ChangeSelfOrder/suningHeaderList&&maps=" + $("#searchForm").serialize();
