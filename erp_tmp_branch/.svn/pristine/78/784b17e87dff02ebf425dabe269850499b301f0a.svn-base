	...
	<div class="sfpage table-header-settable">
		<div class="page-orderWait">
			<div class="tabBar cl mb-10">
				...
				<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_TAB" html='<a class="btn-tabBar current" href="${ctx }/order/getWwgList/djs">待结算<sup id="tab_c3">0</sup></a>'></sfTags:pagePermission>
				<p class="f-r btnWrap">
			...
			<div class="pt-10 pb-5 cl">
				<div class="f-l">
					<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_ZJFD_BTN" html='<a href="javascript:showzjfd();" class="sfbtn sfbtn-opt"><i class="sficon sficon-notdispatch"></i>直接封单</a>'></sfTags:pagePermission>
					<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_PLSETTLE_BTN" html='<a href="javascript:batchJiesuan();" class="sfbtn sfbtn-opt"><i class="sficon sficon-settlement"></i>批量结算</a>'></sfTags:pagePermission>
					...
					<%-- <sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_PLJIAOKUAN_BTN" html='<a class="sfbtn sfbtn-opt sbtn" value="" type="button" onclick="PLJiaokuan()"><i class="sficon sficon-plfk"></i>批量交款</a>'></sfTags:pagePermission> --%>
					<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_PLJIAODAN_BTN" html='<a class="sfbtn sfbtn-opt sbtn" value="" type="button" onclick="PLJiaoDan()"><i class="sficon sficon-pljd"></i>批量交单</a>'></sfTags:pagePermission>
				</div>
				<div class="f-r">
					<a href="javascript:;" class="sfbtn sfbtn-opt2 reloadPageBtn"><i class="sficon sficon-reload"></i>刷新</a>
					<%-- 	<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_IMPORT_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2"><i class="sficon sficon-import"></i>导入</a>'></sfTags:pagePermission> --%>
					<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_EXPORT_BTN" html='<a onclick="return exports()"class="sfbtn sfbtn-opt2" target="_blank"><i class="sficon sficon-export"></i>导出</a>'></sfTags:pagePermission>
					<sfTags:pagePermission authFlag="ORDERMGM_STAYVISTORDER_STAYSETTLE_TBSETTLE_BTN" html='<a href="javascript:;" class="sfbtn sfbtn-opt2" id="setHeadersBtn"><i class="sficon sficon-setting"></i>表头设置</a>'></sfTags:pagePermission>
				</div>
  ...
  function showwxgd(){
    ...
    function initSfGrid(){
        $("#table-waitdispatch").sfGrid({
            url : '${ctx}/order/getOrderMenuList/djs?ptype='+${ptype},
            sfHeader: defaultHeader,
            sfSortColumns: sortHeader,
            rownumbers:true,
    ...
    function exports(){
        ...
        if(idArr>10000){
            $('body').popup({
                ...
                content:content,
                fnConfirm :function(){
                    location.href="${ctx}/order/export?formPath=/a/order/getWwgList/djs&&maps="+$("#searchForm").serialize();
                },
                fnCancel: function () {
...
//    }
    function reAccount(rowData){
        ...
        if(rowData.record_account=='1'){
            ...
            if('${fns:checkBtnPermission("ORDERMGM_STAYVISTORDER_DJS_CONFIRMACCOUNT_BTN")}' === 'true'){
    ...
    function fmtWhetherCollection(rowData) {
     	if (rowData.status == "3" || rowData.status == "4" ) {//|| rowData.status == "5"
     		if ("0" == rowData.whether_collection || "2" == rowData.whether_collection) {
     			if('${fns:checkBtnPermission("ORDERMGM_STAYVISTORDER_STAYSETTLE_RETURNMONEYCONFIRM_BTN")}' === 'true'){
     ...
     function fmtRC(rowData) {//交单情况
     	if (rowData.status == "3" || rowData.status == "4" || rowData.status == "5" || rowData.status == "8" ) {
     		if ("0" == rowData.return_card || "2" == rowData.return_card) {
     			if('${fns:checkBtnPermission("ORDERMGM_STAYVISTORDER_STAYSETTLE_RETURNCARDCONFIRM_BTN")}' === 'true'){
