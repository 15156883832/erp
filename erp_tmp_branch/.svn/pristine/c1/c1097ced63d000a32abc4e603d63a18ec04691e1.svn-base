...
<div class="sfpagebg bk-gray">
    <div class="pt-25 pb-25 pl-20 pr-20">
        <div class="goodsDetail">
                ...
                <div class="f-l">
                    ...
                    <div class="goodsPrice mb-15 cl">
                        <div class="f-l col-3-1">
                            <span class="f-13">官方指导价：</span><strong class="c-fd6e32 f-18">￥2979.00</strong>
                        </div>
                        <div class="f-l col-3-1">
                            <span class="f-13">促销零售价：</span><strong class="c-fd6e32 f-18">￥2198.00</strong>
                        </div>
                        <div class="f-l col-3-1">
                            <span class="f-13">促销奖励金：</span><strong class="c-fd6e32 f-18">￥1000.00</strong>
                        </div>
                    </div>
            ...
            <div class="text-c pos-r goodsImgsMain">
