        ...
        <div class="goodsDetail">
            <div class="cl mb-20">
                <div class="f-l w-480">
                    ...
                    <div class="commodityImgListWrap f-l" id="commodityImgListWrap">
                        ...
                        <div class="commodityImgList">
                            <ul id="adlist">
                                <li class="">
                                    <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/theme1.jpg" />
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="f-l">
                    ...
                    <a class="btn_buyGoods radius" href="javascript:showBuyCode('${platform.columns.id}');">立即购买</a>
                </div>
            </div>
            ...
            <div class="text-c goodsImgsMain">
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_01.png"  />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_02.png" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_03.png" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_04.png" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_05.png" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_06.png" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/codeImgs/detail_07.jpg" class="mb-10" style="max-width: 1000px;" />
            </div>
        </div>
    </div>
</div>
