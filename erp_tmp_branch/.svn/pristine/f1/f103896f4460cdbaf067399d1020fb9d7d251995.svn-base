    ...
    <dl class="leftmenu">
	   <c:set var="firstMenu" value="true"/>
	    ...
	    <dd style="margin-bottom: 1px;">
	    	...
	    	<ul class="menuson">
			    <c:forEach items="${menu.items}" var="menuChild">
				    <li id="li_${menuChild.id}" style="height: 40px;" onmouseover="ov(this.id)" onmouseout="ot(this.id)"><cite></cite><a class="lk" href="${menuChild.href }" target="rightFrame" >&nbsp;${menuChild.name}</a></li>
	       ...
	       <%-- <dd style="margin-bottom: 1px;">
	       		<div class="title" style="height: 47px;">
	       			<span><img src="${ctxStatic}/images/leftico01.png" /></span>&nbsp;付款详情
	       			<div name="showDropDiv" class="shw"></div>
	       		</div>
	       		<ul class="menuson">
	       			<li id="li_${menuChild.id}" style="height: 40px;" onmouseover="ov(this.id)" onmouseout="ot(this.id)"><cite></cite>
	       				<a class="lk" href="#" target="rightFrame" >&nbsp;
	       					付款详情
	       				</a>
	       			</li>
	       		</ul>
