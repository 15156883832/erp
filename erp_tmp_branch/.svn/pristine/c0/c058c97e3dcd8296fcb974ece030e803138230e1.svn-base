...
public class CrmOrder400 implements Serializable{
    /**
	 * 
	 */
    ...
    public void setcServiceMode(String cServiceMode) {
        this.cServiceMode = cServiceMode;
    }
    ...
    public void setEmploye1(String employe1) {
    ...
    public void setEmploye2(String employe2) {
    ...
    public void setEmploye3(String employe3) {
