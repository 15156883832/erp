...
<html>
	<head>
		<title>jojowonet Mobile 登录</title>
	...
	<div data-role="page">
		...
		<div role="main" class="ui-content">
			<div id="messageBox" class="<%=error==null?"hide":""%>">
				<label id="loginError" class="error"><%=error==null?"":"com.jojowonet.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
			</div>
		...
		<div data-role="footer"  data-theme="b">
			<h4>Copyright 2013 The jojowonet Foundation</h4>
		</div><!-- /footer -->
	</div><!-- /page -->
	</body>
</html>