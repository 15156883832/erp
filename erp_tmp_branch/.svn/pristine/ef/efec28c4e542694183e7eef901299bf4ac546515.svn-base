...
public class OrderSettlementDetail2017 implements Serializable {
    ...
    public OrderSettlementDetail2017() {
        super();
        this.createTime = new Date();
    }

    public OrderSettlementDetail2017(OrderSettlement settlement) {
