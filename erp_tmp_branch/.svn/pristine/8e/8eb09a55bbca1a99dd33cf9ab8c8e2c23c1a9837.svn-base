	...
	<form id="tf">
		<div class="">
			...
			<div class="cl mb-15">
				...
				<input type="text " class="input-text f-l w-460  readonly" readonly="readonly" value="${siteSelf.columns.name }" <c:if test="${siteSelf.columns.name=='浩泽家用反渗透直饮机' }">readonly="readonly"</c:if>  id="name" name="name" />
			</div>
			<div class="cl mb-15 ">
			...
			<div class="cl mb-10">
				...
				<input type="text" class="f-l input-text w-300 readonly" readonly="readonly" placeholder="自动生成支持手动输入" value="${siteSelf.columns.number }" maxlength="20" id="number" name="number" />
			...
			<div class="cl mb-10">
				...
				<input type="text" class="f-l input-text w-300 readonly" id="category"  value="${siteSelf.columns.category }" name="category" readonly="readonly" maxlength="100" />
				<%-- <select class="select f-l w-300" id="category" readonly="readonly" name="category">
			...
			<div class="cl mb-10">
				...
				<input type="text" class="f-l input-text w-300 readonly " readonly="readonly" value="${siteSelf.columns.stocks }" id="gstocks" name="gstocks"  />
				<label class="w-120 f-l">商品单位：</label>
				<div class="priceWrap f-l w-300 readonly">
					<input type="text" class="f-l input-text w-300" id="punit" value="${siteSelf.columns.unit }" readonly="readonly" maxlength="10" name="unit" />
				</div>
			</div>
			<div class="cl mb-10">
			...
			<div class="cl mb-10">
				...
				<input type="text" class="f-l input-text w-300 readonly" readonly="readonly" maxlength="10" value="${siteSelf.columns.repair_term }" id="repairTerm" name="repairTerm" />
			</div>
			...
			<div class="cl mb-10">
				...
				<div class="priceWrap f-l w-300 readonly">
					<input type="text" class="input-text" value="${siteSelf.columns.site_price }" readonly="readonly"  id="gsitePrice" name="gsitePrice" datatype="*" errormsg="格式错误" nullmsg="入库价格" />
			...
			<div class="cl mb-10">
				...
				<input type="text" class="f-l input-text w-300 readonly" value="${siteSelf.columns.jd_seller_link }" readonly="readonly" name="jdSellerLink" />
				<label class="w-120 f-l">淘宝比较链接：</label>
				<input type="text" class="f-l input-text w-300 readonly" value="${siteSelf.columns.tmall_seller_link }" readonly="readonly" name="tmallSellerLink" />
			</div>
			...
			<div class="" style="margin: 0 auto; width: 1000px;">
				<div class="">
					...
					<textarea class="textarea h-50 hide" value="" id="html" value="" name="html"></textarea>
				</div>
			</div>
		</div>
	</form>
...
<script type="text/javascript">
	...
	$(function(){
		$("#saveClick").bind("click",function(){
			...
			$("#html").val('${siteSelf.columns.html }');
