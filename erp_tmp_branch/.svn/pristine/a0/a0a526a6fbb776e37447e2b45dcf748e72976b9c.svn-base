					...
					<div class="col-5-1 f-l">
						<div class="sysSetBox" >
                           ...
                           <sfTags:pagePermission authFlag="NEWSYSSET_NEWFACTORYMSG_NEWFACTORYMSG_TAB" html='<p><a class="sysLink" data-href="${ctx}/order/siteVenderAccount" data-title="厂家资料设置"><strong class="lh-20">厂家资料设置</strong> </a></p>
							...
							<sfTags:pagePermission authFlag="NEWSMSMGM_NEWSIGN_NEWSET_TAB" html='<p><a class="sysLink" data-href="${ctx}/order/smstempletSet/headlist" data-title="短信设置"><strong class="lh-20">短信设置</strong> </a></p>
							...
							<sfTags:pagePermission authFlag="NEWSMSMGM_NEWSIGN_VEHICLE_TAB" html='<p><a class="sysLink" data-href="${ctx}/operate/siteVehicle" data-title="车辆信息设置"><strong class="lh-20">车辆信息设置</strong> </a></p>
							<p class="c-888 lh-20 mb-10">车辆信息、司机信息设置</p>'></sfTags:pagePermission>
