            ...
            function fmtOper(rowData) {
                ...
                if ('${fns:checkBtnPermission("FITTINGMGM_FITAPPLY_WAITEAPPLY_APPLY_BTN")}' === 'true') {
                    if (rowData.status == 1 && parseFloat(rowData.fitting_apply_num) <= parseFloat(rowData.warning)) {
                        html = '<span class="oState state-quejian " title="缺件已到"></span><a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    }else if(rowData.status == 1 && parseFloat(rowData.fitting_apply_num) > parseFloat(rowData.warning) && rowData.fapStatus == 1){
                        html = '<span class="oState state-quejian2 " title="缺件在途"></span><a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    }else if(rowData.status == 1 && parseFloat(rowData.fitting_apply_num) > parseFloat(rowData.warning) && rowData.fapStatus == 2){
                        html = '<span class="oState state-quejian1 " title="缺件中"></span><a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    }else if(rowData.status == 1 && parseFloat(rowData.fitting_apply_num) > parseFloat(rowData.warning) && rowData.fapStatus == 3){
                        html = '<span class="oState state-quejian1 " title="缺件中"></span><a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    }else if(rowData.status == 1 && parseFloat(rowData.fitting_apply_num) > parseFloat(rowData.warning) && isBlank(rowData.fapStatus)){
                        html = '<span class="oState state-quejian1 " title="缺件中"></span><a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    } else {
                        html = '<a href="javascript:Toexamine(\'' + rowData.id + '\',\'' + rowData.fitting_id + '\');" class="oState state-verify c-0383dc" >审核</a>';
                    }
                }
                return html;
            }
