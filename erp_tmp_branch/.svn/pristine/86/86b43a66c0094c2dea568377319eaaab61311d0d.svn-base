...
<script type="text/javascript">
    ...
    function gotoBuyingPage(id,good_sign,name){
		if("TP20180102"==$.trim(good_sign)){
		    ...
		    var href='${ctx}/goods/sitePlatformGoods/showBuySouthLbUpgrade?id='+id;
            showBuyPage(href,name);
		} */else if("LB18102201"==$.trim(good_sign) || "LB18102202"==$.trim(good_sign) || "BS20180108"==$.trim(good_sign) || "BS20180107"==$.trim(good_sign)){//LB18102201  or LB18102202
		    var href='${ctx}/goods/sitePlatformGoods/showBuySouthLbUpgrade?id='+id;
            showBuyPage(href,name);
            ...
            showBuyPage(href,name);
		}else if("WT18040301"==$.trim(good_sign) || "WT18040302"==$.trim(good_sign) || "WT18040303"==$.trim(good_sign)){//水龙头
            var href='${ctx}/goods/sitePlatformGoods/showBuySouthSltUpgrade?id='+id;
            showBuyPage(href,name);
		}else if("WT18040302"==$.trim(good_sign) || "WT18040303"==$.trim(good_sign)){//水龙头升级
            var href='${ctx}/goods/sitePlatformGoods/showBuySouthSltUpgrade?id='+id;
            showBuyPage(href,name);
