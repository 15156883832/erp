            ...
            <form id="orderForm" >
                        <div class="mb-25">
                            <table class="table buyDetailTable text-c">
                                ...
                                <tbody>
                                <tr id="10ANan"
                                    class="radius  <c:if test="${platform.columns.good_sign ne 'QJ18040201'}">hide</c:if>">
                                    <td>
                                        ...
                                        <div class="wrap1 w-140" style="margin: 0 auto;">
                                            <div class="countWrap w-140 mb-5">
                                                ...
                                                <div class="priceWrap readonly">
                                                    <input type="text" id="adj_num10" readonly name="quantity10" class="input-text text-c readonly" value="5"/>
                                    ...
                                    <td>
                                        <div class="wrap1 ${platform.columns.good_sign eq 'QJ18040201' ? '':'hide'}"><a class="btn_add  " onclick="addGoods()">添加商品</a></div>
                                        <div class="wrap1 hide"><a class="btn_del" onclick="deleteGood('10ANan')">删除商品</a></div>
                                    </td>
                                </tr>
                                <tr id="16ANan"
                                    class="radius <c:if test="${platform.columns.good_sign ne 'QJ18040202'}">hide</c:if>">
                                    <td>
                                        <div class="wrap1 text-l ">
                                            <div class="imgWrap imgWrap">
                                    ...
                                    <td>
                                        <div class="wrap1 w-140" style="margin: 0 auto;">
                                            <div class="countWrap w-140 mb-5">
                                                ...
                                                <div class="priceWrap readonly">
                                                    <input type="text" id="adj_num16" readonly name="quantity16" class="input-text text-c readonly" value="5"/>
                                    ...
                                    <td>
                                        <div class="wrap1 ${platform.columns.good_sign eq 'QJ18040202' ? '':'hide' }">
                            ...
                            <div class="cl mb-10 hide">
                                ...
                                <input type="hidden" name="pid10A" value="${platform.columns.good_sign eq 'QJ18040201' ? platform.columns.id:'' }"/>
                                <input type="hidden" name="pid16A" value="${platform.columns.good_sign eq 'QJ18040202' ? platform.columns.id:'' }"/>
...
<script type="text/javascript">
    ...
    function checkout() {
        ...
        $.ajax({
            url: "${ctx}/goods/sitePlatformGoods/createDetergentOrder",
            type: "POST",
