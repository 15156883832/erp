...
<div class="page-orderWait">
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl mb-10">
			<a class="btn-tabBar "  href="${ctx }/goods/platFormOrder/msgHeaderList">短信销售记录</a>
			<a class="btn-tabBar current"  href="${ctx }/goods/platFormOrder/msgHeaderListerror">未支付短信订单</a>
			<p class="f-r btnWrap">
...
function initSfGrid(){
	$("#table-waitdispatch").sfGrid({
		url : '${ctx}/goods/platFormOrder/msgGriderror',
...
function exports(){
	...
	if(idArr>10000){
		$('body').popup({
			...
			content:content,
			 fnConfirm :function(){
				 location.href="${ctx}/goods/platFormOrder/export1?formPath=/a/goods/platFormOrder/msgHeaderListerror&&maps="+$("#searchForm").serialize(); 
			 }
		});
	}else{
		 location.href="${ctx}/goods/platFormOrder/export1?formPath=/a/goods/platFormOrder/msgHeaderListerror&&maps="+$("#searchForm").serialize();
