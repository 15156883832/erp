...
<div class="dislpayArrow " id="dislpayArrowq"><a class="pngfix" href="javascript:void(0);" onClick="displaynavbar2(this)"></a></div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#jumpToGift").click(function() {
            ...
            init_left_menu('cc3930152a2a4c51989adc4b8c160298','运营管理','v7', function () {
                var aSide = $('#Hui-aside', window.document);
                changeLocation('运营管理','分享会员奖励');
                aSide.find("a[data-title='分享会员奖励']").click();
                aSide.find("a[data-title='分享会员奖励']").parent().addClass('current');
            });
        });
