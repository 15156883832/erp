    ...
    <div class="pt-25 pb-25 pl-20 pr-20">
        <div class="goodsDetail">
                ...
                <div class="f-l w-480">
                    ...
                    <div class="commodityImgListWrap f-l" id="commodityImgListWrap">
                        ...
                        <div class="commodityImgList">
                            <ul id="adlist">
                                <li class="">
                                    <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/messagesImgs/goods_msg_001.png" />
                                </li>
                                <li>
                                    <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/messagesImgs/goods_msg_002.jpg" />
                                </li>
                                <li>
                                    <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/messagesImgs/goods_02.png" />
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="f-l">
                    ...
                    <div class="goodsPrice mb-15 cl">
                        <div class="f-l col-3-1">
                            <span class="f-13">一万条以内：</span><strong class="c-fd6e32 f-18">0.1元 / 条</strong>
                        </div>
                        <div class="f-l col-3-1">
                            <span class="f-13">1-2万条：</span><strong class="c-fd6e32 f-18">0.08元 / 条</strong>
                        </div>
                        <div class="f-l col-3-1">
                            <span class="f-13">2万条及以上：</span><strong class="c-fd6e32 f-18">0.07元 / 条</strong>
                        </div>
                    </div>
                    <p class="lh-20 f-14 mb-15 w-640 c-888">思方专业定制，全网通用，实时发送，高效便捷。</p>
                    <a class="btn_buyGoods radius" href="javascript:buyMessage('${platform.columns.id}');">立即购买</a>
                </div>
            </div>
            ...
            <div class="text-c goodsImgsMain">
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/messagesImgs/detail_01.jpg" class="mb-10" style="max-width: 1000px;" />
                <img src="${ctxPlugin}/static/h-ui.admin/images/goodsImgs/messagesImgs/detail_02.jpg" class="mb-10" style="max-width: 1000px;" />
            </div>
        </div>
    </div>
</div>
