...
<div class="cl mt-10 ">
	...
	<div class="f-l w-140 priceWrap readonly">
		<input type="text" class="input-text readonly" disabled="disabled" value="${st.orderSettlement.sumMoney }"/>
		<span class="unit">元</span>
	</div>
	<label class="f-l w-100">明细：</label> 
	<input type="text" class="input-text w-480 f-l readonly" disabled="disabled" value="${st.orderSettlement.costDetail }" />
</div>
<div class="cl mt-10 order1.0">
	<label class="f-l w-80">结算日期：</label> 
	<input type="text" class="input-text w-140 f-l readonly" disabled="disabled" value="<fmt:formatDate value="${st.orderSettlement.createTime}" pattern="yyyy-MM-dd"/>" /> 
	<label class="f-l w-100">利润：</label> 
	<input type="text" class="input-text w-140 f-l readonly" disabled="disabled" value="${st.orderSettlement.profits}"/>
	<label class="f-l w-100">结算人：</label> 
	<input type="text" class="input-text w-140 f-l readonly" disabled="disabled" value="${st.orderSettlement.createName }"/>
</div>
<div class="mt-10 cl mb-10 order1.0">
	<label class="f-l w-80">备注内容：</label> 
	<input type="text" class="input-text f-l readonly" style="width: 620px;" disabled="disabled" value="${st.orderSettlement.remarks}" />
</div>
</c:if>
...
<div class="cl mb-10 ">
    ...
    <div class="priceWrap w-100 f-l readonly">
        <input type="text" class="input-text readonly" readonly="readonly" value="${st.orderSettlement.factoryMoney}"/>
        <span class="unit">元</span>
    </div>
</div>
<div class="cl mb-10 ">
...
<div class="f-l lh-26">
	...
	<span class="f-l ml-10 c-888">（当日支付：<input id="payed" readonly="readonly" style="border:none" class="input-text w-60 c-888" value="${st.orderSettlement.paymentAmount}" /> 元）</span>
</div>
<div class="cl mb-10">
	...
	<div class="priceWrap w-100 f-l fucaiCostWrap readonly">
		<input type="text" class="input-text"  value="${st.orderSettlement.fittingCosts}" id="afee" onkeyup="calcOverall();" readonly="readonly"/>
		<span class="unit">元</span>
	</div>
</div>
<%-- <div class="cl mb-10 ">
...
<div class="retractWrap ">
    <div class="pos-r pl-160 ">
        ...
        <div class="cl" style="min-height: 26px;">
            <c:forEach var="item" items="${st.dispEmpSettlementDetail}">
                <div class="f-l mb-10">
                    <label class="f-l w-80 text-r textColon">${item.employeName}</label>
                    <div class="priceWrap w-70 f-l readonly">
                        <input type="text" class="input-text" readonly="readonly" value="${item.sumMoney}" />
                        <span class="unit">元</span>
                    </div>
                </div>
            </c:forEach>
    ...
    <div class="bk-blue-dotted pt-10 cl mb-10 retractBox">
	    ...
	    <div class="pos-r pl-90 ml-10 mb-10" style="padding-right:17px;">
		    ...
		    <input type="text" class="input-text readonly " style="width:100%;" readonly="readonly" value="${st.orderSettlement.remarks}"/>
		</div>
    </div>
</div>
<div class="retractWrap ">
...
<div class="cl mb-10 ">
    ...
    <input type="text" value="<fmt:formatDate value="${st.orderSettlement.settlementTime}" pattern="yyyy-MM-dd"/>" class="input-text w-140 f-l readonly" readonly="readonly">
</div>
...
<div class="cl mb-10 order2.0">
    ...
    <div class="priceWrap w-100 f-l readonly">
        <input type="text" class="input-text" value="${st.orderSettlement.profits}" readonly="readonly"/>
        <span class="unit">元</span>
    </div>
    <label class="w-100 text-r f-l lh-26" style="margin-left: 320px"> <span class="c-005aab va-t">当日支付</span>：</label>
    <div class="priceWrap w-100 f-l readonly">
        <input type="text" class="input-text" value="${st.orderSettlement.paymentAmount}" id="payed-mirror" readonly="readonly"/>
        <span class="unit">元</span>
    </div>
</div>
</c:if>