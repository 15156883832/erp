                    ...
                    <div class="cl mb-10">
                        ...
                        <div class="f-l protoInfoWrap2">
                            ...
                            <div class="cl bg-fff9f5 pt-10 pb-10 pl-10 pr-10 lh-24 ">
                                <div class="f-l">
                                    <span class="c-666">&#12288;商品价格：</span><span class="f-16">￥${platform.columns.site_price + 5}</span>
                                </div>
                                <div class="f-r">
                            ...
                            <div class="cl bg-fff2e8 pt-10 pb-10 pl-10 lh-24">
                                <c:if test="${platform.columns.name eq '光头强（八边形底脚洗衣机底座）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥220.00</span>
                                </c:if>
                                <c:if test="${platform.columns.name eq '熊大（大号平脚洗衣机底座）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥180.00</span>
                                </c:if>
                                <c:if test="${platform.columns.name eq '灰太狼（普通平脚洗衣机底座小）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥150.00</span>
                                </c:if>
                                <c:if test="${platform.columns.name eq 'DK型冰箱底座（对开门/多门）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥360.00</span>
                                </c:if>
                                <c:if test="${platform.columns.name eq 'DM型冰箱底座（多门）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥320.00</span>
                                </c:if>
                                <c:if test="${platform.columns.name eq 'PB型冰箱底座（普冰）'}">
                                    <span class="c-666">建议零售价：</span><span class="f-16">￥220.00</span>
                                </c:if>
