...
<body >
	...
	<h1 class="jpageTitle">工单回访</h1>

	<div class="partContainer">
		<div class="partNote mb-15">1、打开工单详情；</div>
		<img src="${ctxPlugin}/static/h-ui.admin/images/help/gd_hf1.png" class="img" />
		<div class="partNote mb-15">2、点击【回访】，打开回访页面；</div>
		<img src="${ctxPlugin}/static/h-ui.admin/images/help/gd_hf2.png" class="img" />
		<div class="partNote pb-25">3、输入回访结果，点击【保存】，完成工单回访操作。</div>
	</div>
