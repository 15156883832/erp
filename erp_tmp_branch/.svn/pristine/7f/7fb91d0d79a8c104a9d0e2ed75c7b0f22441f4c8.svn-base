...
(function (global, factory) {
  ...
  function dispatchEvent(element, type, data) {
    ...
    if (element.dispatchEvent) {
      ...
      return element.fireEvent('onreadystatechange');
    }
  }
  ...
  Viewer.prototype = {
    ...
    init: function () {
	  ...
	  if(window.innerHeight!= undefined){  
	        ...
	        windowInnerWidth = Math.min(D.clientHeight, B.clientHeight);  
      } 
      _this.scrollbarWidth = windowInnerWidth - document.body.clientWidth;
    ...
    open: function () {
	  ...
	  if(this.scrollbarWidth != undefined && !isNaN(this.scrollbarWidth)){
//	      body.style.paddingRight = this.scrollbarWidth + 'px';
		  body.style.setAttribute('paddingRight', this.scrollbarWidth + 'px');
	  }
