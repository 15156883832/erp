...
<body >
	...
	<h1 class="jpageTitle">商品类别设置</h1>
	<div class="partContainer">
		<div class="partNote textIndent"></div>
		<div class="cl">
			<img src="${ctxPlugin}/static/h-ui.admin/images/help/bj_app_dj4.png" class="f-l" />
		</div>
