  ...
  <body>
	...
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl mb-10">
			...
			<%-- <a class="btn-tabBar " href="${ctx}/order/statistics/getStatistics">统计报表</a>  --%> 
				...
				<div class="bk-gray pt-10 pb-5 mb-10">
					<table class="table table-search">
						...
						<tr class="moreCondition" style="display: none;">
							...
							<td colspan="5">
								<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'createTimemax\')||\'%y-%M-%d\'}'})" id="createTimemin" name="createTimemin" value="" class="input-text Wdate w-100" style="width:120px">
								至
								<input type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'createTimemin\')}',maxDate:'%y-%M-%d'})" id="createTimemax" name="createTimemax"  value="" class="input-text Wdate w-100" style="width:120px">
						...
						<tr class="moreCondition" style="display: none;">
							...
							<td >
								<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'update_timemax\')}'})" id="update_timemin" name="update_timemin" value="" class="input-text Wdate w-120" style="width:120px">
								至
								<input type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'update_timemin\')}'})" id="update_timemax" name="update_timemax"  value="" class="input-text Wdate w-120" style="width:120px">
...
function exports(){
	  location.href = "${ctx}/order/statistics/exportStatistics?formPath=/a/order/statistics&&maps=" + $("#searchForm").serialize();
}
