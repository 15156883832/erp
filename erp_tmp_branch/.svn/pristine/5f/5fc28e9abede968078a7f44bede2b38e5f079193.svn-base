...
<body>
	...
	<div class="sfpage table-header-settable">
		...
		<div class="mt-10 cl" id="allHeader">
			<div class="f-l pl-20 pt-15 pb-15 bk-gray stockboxCur bgstyle" onclick="stockComStatistics(1,this)"  style="width: 28%;border-right: 0;cursor:pointer;">
	...
	<%--<div class="mt-10 bk-gray pd-15">
		...
		<form action=""  id="cx">
			...
			<div class="cl mt-15">
				<input type="hidden" name="whoStatistics" id="whoStatistics" value="1">
