...
<div class="popupBox w-600 addSecondSite" >
	...
	<div class="popupContainer"  >
		<div class="popupMain pl-15 pr-15 pt-15 pb-50 pos-r" style="height:240px">
				<div class="cl mb-10 " >
					<label class="f-l w-160"><em class="mark"></em>二级网点类型：</label>
					<label for="net"><input type="radio" name="type" id="net" value="1" checked="checked"/> 直营网点</label>
					<label class="ml-50" for="net1"><input type="radio" name="type" id="net1" value="2"/> 合作网点</label>
				</div>
...
<!-- 				<p class="mb-10 lh-24 f-14 c-f55025" style="padding-left:10px">说明：所添加的二级网点需要先在思方系统内注册账号。</p> -->
				...
				<div class="cl mb-10 " >
					<label class="f-l w-160"><em class="mark"></em>二级网点注册名称：</label>
					<input type="text" class="input-text w-300 f-l  labelname" maxlength="50" id="newSiteName"/>
				</div>
				<div class="cl mb-10 ">
					<label class="f-l w-160"><em class="mark"></em>二级网点注册手机号：</label>
					<input type="text" class="input-text w-300 f-l  labelsort" maxlength="20" id="newSiteMobile" /> 
				</div>
				<div class="cl mb-10 " >
					<label class="f-l w-160"><em class="mark"></em>短信验证码：</label>
					<input type="text" class="f-l w-190 input-text" id="mobileMsg"/>
