				...
				<div id="tab-system" class="HuiTab">
					<div class="tabBar cl mb-10">
						...
						<c:if test="${map.geli eq 'has'}">
							<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_GELIORDER_TAB"
								html='<a id="geli" class="btn-tabBar current"  href="${ctx }/order/ChangeSelfOrder/geliHeaderList">格力工单</a>'></sfTags:pagePermission>
						</c:if>
					...
					<div class="tabCon">
							...
							<div class="bk-gray pt-10 pb-5">
								<table class="table table-search">
									<tr>
										...
										<td id="reloadSpan">
											<span class="dropdown-sin-2 w-150">
												<select class="select" name="status" id="status" multiple>
													<!--未完工-->
													<option value="保存">保存</option>
													<option value="待网点派工">待网点派工</option>
													<option value="待服务人员处理">待服务人员处理</option>
													<option value="待件">待件</option>
													<option value="拉修中">拉修中</option>
													<option value="用户改约">用户改约</option>
													<option value="延误">延误</option>
													<option value="服务人员接收">服务人员接收</option>
													<option value="服务人员拒绝">服务人员拒绝</option>
													<option value="用户反馈">用户反馈</option>
													<option value="服务人员报完工">服务人员报完工</option>
													<!--已完工-->
													<option value="分部报完工">分部报完工</option>
													<option value="网点报完工">网点报完工</option>
													<option value="批量关闭">批量关闭</option>
													<option value="正常关闭">正常关闭</option>
									...
									<tr>
										...
										<td>
											<input type="text" class="input-text" style="width: 150px;" name="customerMobile" onkeydown="enterEvent(event)" />
						...
						<div class="pt-10 pb-5 cl">
							<div class="f-l">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_ZHUANZIJIE_BTN"
									html='<a href="javascript:;" class="sfbtn sfbtn-opt" onclick="zzj();"><i class="sficon sficon-zzj"></i>转自接</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_PLDELETE_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_MARKORDER_BTN"
									html='<a href="javascript:showMarkOrders();" class="sfbtn sfbtn-opt"><i class="sficon sficon-sign"></i>标记工单</a>'></sfTags:pagePermission>
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_CANCELMARK_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_PLPRINT_BTN"
							...
							<div class="f-r">
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_EXPORT_BTN"
								...
								<sfTags:pagePermission authFlag="ORDERMGM_FOURORDER_AOKESIORDER_HEADERSET_BTN"
	...
	<script type="text/javascript">
		...
		function initSfGrid() {
			$("#table-waitdispatch").sfGrid({
				url : '${ctx}/order/ChangeSelfOrder/FourGeliOrder',
				sfHeader : defaultHeader,
				sfSortColumns : sortHeader,
				rownumbers : true,
		...
		function exports() {
			...
			if (idArr > 10000) {
				$('body').popup({
					...
					content : content,
					fnConfirm : function() {
						location.href = "${ctx}/order/ChangeSelfOrder/exportGeli?formPath=/a/order/ChangeSelfOrder/geliHeaderList&&maps=" + $("#searchForm").serialize();
					}
				});
			} else {
				location.href = "${ctx}/order/ChangeSelfOrder/exportGeli?formPath=/a/order/ChangeSelfOrder/geliHeaderList&&maps=" + $("#searchForm").serialize();
