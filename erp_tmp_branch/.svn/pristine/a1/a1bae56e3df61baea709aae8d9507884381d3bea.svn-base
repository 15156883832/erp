					...
					<table class="table table-bg table-border table-bordered table-sdrk" style="table-layout: fixed;">
						...
						<c:forEach items="${page.list }" var="item" varStatus="sta">
							<tr class='tr'>
								...
								<td class="no-pd">
									<div class="bb h-30 pd-5" style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;width:100%;' title="${item.columns.sign_point}">${item.columns.sign_point }</div>
								</td> 
								<td class="no-pd">
