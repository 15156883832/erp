	...
	<div class="page-orderWait">
		...
		<form action="${ctx}/statistic/employeIndex"  id="cx" method="post">
			<div class="cl mt-15">
				...
				<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'bxdatemax\')||\'%y-%M-%d\'}',minDate:'%y-01-01',isShowClear:false})" id="bxdatemin" name="bxdatemin" value="${startStr }" class="input-text Wdate w-140" readonly>
				至
